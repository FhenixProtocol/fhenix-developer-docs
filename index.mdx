...
Learn the fundamentals by building an encrypted counter contract.
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="Client SDK" icon="puzzle-piece" href="/client-sdk/introduction/overview">
JavaScript library for encrypting inputs, managing ACPs, and decrypting outputs.
</Card>
