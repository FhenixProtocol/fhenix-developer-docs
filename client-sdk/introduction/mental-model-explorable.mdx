...
<head>
  ...
  <title>The Counter, End to End Diagram</title>
  <script>
...
<body>
  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 1000 640" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">The Counter, End to End</title>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="158" width="904" height="162" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="330" width="904" height="102" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="2" x="48" y="442" width="904" height="104" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 137.5 142 L 137.5 575" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 324.25 142 L 324.25 575" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 511 142 L 511 575" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 697.75 142 L 697.75 575" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 884.5 142 L 884.5 575" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="319.25" y="184" width="10" height="378" rx="3" class="c-mask"/>
        <rect x="319.25" y="184" width="10" height="378" rx="3" class="c-external" stroke-width="1"/>
        <rect x="879.5" y="221" width="10" height="341" rx="3" class="c-mask"/>
        <rect x="879.5" y="221" width="10" height="341" rx="3" class="c-cloud" stroke-width="1"/>
        <rect x="692.75" y="295" width="10" height="111" rx="3" class="c-mask"/>
        <rect x="692.75" y="295" width="10" height="111" rx="3" class="c-backend" stroke-width="1"/>
        <rect x="506" y="347" width="10" height="155" rx="3" class="c-mask"/>
        <rect x="506" y="347" width="10" height="155" rx="3" class="c-backend" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="add 5 to my counter" data-edge-key="0" data-edge-id="add">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="add" data-composition-points="137.5,178.0;324.25,178.0" d="M 137.5 178.0 L 324.25 178.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="175.475" y="158" width="110.8" height="16" rx="3" class="c-mask"/>
          <text x="230.875" y="168" class="t-backend" font-size="9" text-anchor="middle">add 5 to my counter</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="cofhe" data-edge-label="encrypted value + ZK proof" data-edge-key="1" data-edge-id="submit">
          <path data-composition-edge-from="sdk" data-composition-edge-to="cofhe" data-composition-edge-id="submit" data-composition-points="329.25,226.0;879.5,226.0" d="M 329.25 226.0 L 879.5 226.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="530.775" y="206" width="147.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="604.375" y="216" class="t-backend" font-size="9" text-anchor="middle">encrypted value + ZK proof</text>
        </g>
        </g>

        <g data-edge-from="cofhe" data-edge-to="sdk" data-edge-label="ciphertext handle + batch signature" data-edge-key="2" data-edge-id="handle">
          <path data-composition-edge-from="cofhe" data-composition-edge-to="sdk" data-composition-edge-id="handle" data-composition-points="879.5,264.0;329.25,264.0" d="M 879.5 264.0 L 329.25 264.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="507.375" y="244" width="194" height="16" rx="3" class="c-mask"/>
          <text x="604.375" y="254" class="t-muted" font-size="9" text-anchor="middle">ciphertext handle + batch signature</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="chain" data-edge-label="transaction with handle and proof" data-edge-key="3" data-edge-id="send">
          <path data-composition-edge-from="sdk" data-composition-edge-to="chain" data-composition-edge-id="send" data-composition-points="329.25,300.0;692.75,300.0" d="M 329.25 300.0 L 692.75 300.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="419.2" y="280" width="183.6" height="16" rx="3" class="c-mask"/>
          <text x="511" y="290" class="t-backend" font-size="9" text-anchor="middle">transaction with handle and proof</text>
        </g>
        </g>

        <g data-edge-from="chain" data-edge-to="contract" data-edge-label="increment(handle, proof)" data-edge-key="4" data-edge-id="increment">
          <path data-composition-edge-from="chain" data-composition-edge-to="contract" data-composition-edge-id="increment" data-composition-points="692.75,352.0;516.0,352.0" d="M 692.75 352.0 L 516.0 352.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="535.975" y="332" width="136.8" height="16" rx="3" class="c-mask"/>
          <text x="604.375" y="342" class="t-backend" font-size="9" text-anchor="middle">increment(handle, proof)</text>
        </g>
        </g>

        <g data-edge-from="contract" data-edge-to="chain" data-edge-label="store the encrypted result" data-edge-key="5" data-edge-id="store">
          <path data-composition-edge-from="contract" data-composition-edge-to="chain" data-composition-edge-id="store" data-composition-points="516.0,400.0;692.75,400.0" d="M 516.0 400.0 L 692.75 400.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="530.775" y="380" width="147.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="604.375" y="390" class="t-backend" font-size="9" text-anchor="middle">store the encrypted result</text>
        </g>
        </g>

        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="read the counter" data-edge-key="6" data-edge-id="readcall">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="readcall" data-composition-points="137.5,462.0;319.25,462.0" d="M 137.5 462.0 L 319.25 462.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="183.275" y="442" width="95.2" height="16" rx="3" class="c-mask"/>
          <text x="230.875" y="452" class="t-backend" font-size="9" text-anchor="middle">read the counter</text>
        </g>
        </g>

        <g data-edge-from="contract" data-edge-to="sdk" data-edge-label="ctHash, the encrypted handle" data-edge-key="7" data-edge-id="cthash">
          <path data-composition-edge-from="contract" data-composition-edge-to="sdk" data-composition-edge-id="cthash" data-composition-points="506.0,496.0;329.25,496.0" d="M 506.0 496.0 L 329.25 496.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="338.825" y="476" width="157.6" height="16" rx="3" class="c-mask"/>
          <text x="417.625" y="486" class="t-muted" font-size="9" text-anchor="middle">ctHash, the encrypted handle</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="cofhe" data-edge-label="decryptForView(ctHash)" data-edge-key="8" data-edge-id="view">
          <path data-composition-edge-from="sdk" data-composition-edge-to="cofhe" data-composition-edge-id="view" data-composition-points="329.25,528.0;879.5,528.0" d="M 329.25 528.0 L 879.5 528.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="541.175" y="508" width="126.4" height="16" rx="3" class="c-mask"/>
          <text x="604.375" y="518" class="t-backend" font-size="9" text-anchor="middle">decryptForView(ctHash)</text>
        </g>
        </g>

        <g data-edge-from="cofhe" data-edge-to="sdk" data-edge-label="the result, sealed to the ACP" data-edge-key="9" data-edge-id="sealed">
          <path data-composition-edge-from="cofhe" data-composition-edge-to="sdk" data-composition-edge-id="sealed" data-composition-points="879.5,556.0;329.25,556.0" d="M 879.5 556.0 L 329.25 556.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="522.975" y="536" width="162.8" height="16" rx="3" class="c-mask"/>
          <text x="604.375" y="546" class="t-muted" font-size="9" text-anchor="middle">the result, sealed to the ACP</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="136" width="102.4" height="18" rx="3" class="c-mask"/>
          <text x="62" y="149" class="t-dim" font-size="9" font-weight="600">Encrypt the input</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="308" width="81.60000000000001" height="18" rx="3" class="c-mask"/>
          <text x="62" y="321" class="t-dim" font-size="9" font-weight="600">Compute on it</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="2">
          <rect x="56" y="420" width="76.4" height="18" rx="3" class="c-mask"/>
          <text x="62" y="433" class="t-dim" font-size="9" font-weight="600">Read it back</text>
        </g>
        ...
        <g id="node-app" data-node-id="app" data-node-label="Your app" tabindex="0" role="button" aria-label="Focus Your app, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          ...
          <rect x="62" y="72" width="151" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="151" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          ...
          <text data-node-label="" x="137.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your app</text>
        </g>
        ...
        <g id="node-sdk" data-node-id="sdk" data-node-label="Client SDK" tabindex="0" role="button" aria-label="Focus Client SDK, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          ...
          <rect x="248.75" y="72" width="151" height="54" rx="6" class="c-mask"/>
          <rect x="248.75" y="72" width="151" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="external" class="semantic-sigil s-external" transform="translate(254.75 78) scale(0.6875)">
            <rect x="2.5" y="5" width="8.5" height="8" rx="1.5"/>
            <path d="M8 2.5h5.5V8M13.5 2.5 7.5 8.5"/>
          </g>
          <text data-node-label="" x="324.25" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Client SDK</text>
        </g>
        ...
        <g id="node-contract" data-node-id="contract" data-node-label="Your contract" tabindex="0" role="button" aria-label="Focus Your contract, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          ...
          <rect x="435.5" y="72" width="151" height="54" rx="6" class="c-mask"/>
          <rect x="435.5" y="72" width="151" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(441.5 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="511" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your contract</text>
        </g>

        <g id="node-chain" data-node-id="chain" data-node-label="Host chain" tabindex="0" role="button" aria-label="Focus Host chain, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          <title>Host chain · Sequence participant</title>
          <rect x="622.25" y="72" width="151" height="54" rx="6" class="c-mask"/>
          <rect x="622.25" y="72" width="151" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(628.25 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="697.75" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Host chain</text>
        </g>

        <g id="node-cofhe" data-node-id="cofhe" data-node-label="CoFHE" tabindex="0" role="button" aria-label="Focus CoFHE, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          <title>CoFHE · Sequence participant</title>
          <rect x="809" y="72" width="151" height="54" rx="6" class="c-mask"/>
          <rect x="809" y="72" width="151" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(815 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="884.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">CoFHE</text>
        </g>

        <!-- Legend -->
        <g data-legend="">
          <text x="40" y="566" class="t-primary" font-size="12" font-weight="650">Legend</text>
          <g data-legend-semantic-kind="emphasis" data-legend-x="40" data-legend-baseline="586" data-legend-width="78">
            <path d="M 40 583 L 74 583" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
            <text x="83" y="586" class="t-muted" font-size="10" font-weight="500">request</text>
          </g>
          <g data-legend-semantic-kind="return" data-legend-x="140" data-legend-baseline="586" data-legend-width="73">
            <path d="M 140 583 L 174 583" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
            <text x="183" y="586" class="t-muted" font-size="10" font-weight="500">return</text>
          </g>
          <g data-legend-semantic-kind="default" data-legend-x="235" data-legend-baseline="586" data-legend-width="118">
            <path d="M 235 583 L 269 583" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
            <text x="278" y="586" class="t-muted" font-size="10" font-weight="500">default message</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        <div class="card-header">
          ...
          <h3>Nothing readable leaves the client</h3>
        </div>
        <ul>
          <li>&bull; The SDK encrypts the 5 and proves it knows the value</li>
          <li>&bull; Only the ciphertext and its proof are submitted</li>
          <li>&bull; The transaction carries a handle, so the chain never sees the number</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>The contract adds without seeing</h3>
        </div>
        <ul>
          <li>&bull; It reads the encrypted counter and calls FHE.add</li>
          <li>&bull; The result is another handle, stored like any other value</li>
          <li>&bull; Neither the contract nor the chain can read either operand</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Only the owner can read it</h3>
        </div>
        <ul>
          <li>&bull; The SDK builds an ACP carrying a sealing key</li>
          <li>&bull; CoFHE seals the result to that key rather than returning a bare value</li>
          <li>&bull; The SDK unseals it locally, so the plaintext exists only on the client</li>
        </ul>
      </div>
    </div>
...
<iframe
  ...
  title="The Counter, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "964 / 570", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
