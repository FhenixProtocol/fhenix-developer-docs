...
- **CoFHE Co-Processor** = Fhenix's offchain service that handles FHE operations
...
2. The SDK generates a ZK proof and submits the encrypted value to the CoFHE verifier's batch endpoint
