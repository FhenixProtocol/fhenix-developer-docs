...
<Frame>
<img src="/images/mental-model.svg" alt="Sequence diagram of the the counter" />
</Frame>

<Tip>
Colour marks the zone. Your app and the Client SDK run client side, your contract and the host chain onchain, and CoFHE offchain. Hover any component or message in the [explorable version](/client-sdk/introduction/mental-model-explorable).
</Tip>
