...
Grants public permission to access the encrypted value.
...
<Warning>
Use `allowPublic` with caution. It grants access to all accounts and contracts.
</Warning>
...
Marks an encrypted value as eligible for public decryption. Once called, anyone can request decryption of this value off-chain via `decryptForTx` without needing a permit.

<ParamField body="value" type="ebool | euint8 | euint16 | euint32 | euint64 | euint128 | eaddress" required>
Encrypted value to allow public decryption for
</ParamField>
