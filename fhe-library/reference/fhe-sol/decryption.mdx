...
Publishes a decrypted result onchain by verifying the signature from [Teecryptor](/deep-dive/cofhe-components/teecryptor). The plaintext is stored and can be read via `getDecryptResultSafe`.
