...
Anyone can call `decryptForTx` offchain to obtain the plaintext values and their signatures from [Teecryptor](/deep-dive/cofhe-components/teecryptor).
</Step>
...
// Submit the proofs onchain to reveal the winner
