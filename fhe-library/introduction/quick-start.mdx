...
{/* @SDK */}
```typescript Full Client SDK Flow
...
- **Authentication**: Uses [Access Control Permissions](/client-sdk/guides/acps) (ACPs) to authenticate connected users when requesting confidential data
...
- Stores plaintext values onchain for testing purposes
...
Handle errors from FHE operations explicitly. Be prepared for potential decryption delays and use appropriate retry mechanisms.
