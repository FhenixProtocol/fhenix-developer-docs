...
2. A **confidential, FHE-encrypted balance**, stored as an `euint64` handle. Nobody, not even the contract, can read it without an ACL grant and an [Access Control Permission](/client-sdk/guides/acps) (ACP).
...
// 4. Read your encrypted balance (returns a handle you decrypt offchain)
