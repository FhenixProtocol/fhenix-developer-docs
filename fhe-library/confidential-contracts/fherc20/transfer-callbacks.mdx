...
description: "Safe transfers with callbacks using IERC7984Receiver interface"
---
...
import "fhenix-confidential-contracts/contracts/interfaces/IERC7984Receiver.sol";
...
```typescript
// Offchain: Prepare encrypted amount
