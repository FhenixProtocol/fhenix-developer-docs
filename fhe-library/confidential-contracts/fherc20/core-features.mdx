...
```typescript Offchain (with @cofhe/sdk)
...
FHERC20 includes optional disclosure functions for transparency when needed. Accounts with access to an encrypted amount can voluntarily reveal it onchain.
