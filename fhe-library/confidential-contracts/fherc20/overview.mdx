...
- Are only revealed when explicitly published on-chain with a valid proof
...
<Card title="FHERC20UnwrapClaim" icon="hand-holding-dollar" href="/fhe-library/confidential-contracts/fherc20/fherc20-wrapper">
**Claim Management**
