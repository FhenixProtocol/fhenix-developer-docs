...
<Tip>
Colour marks the zone. Your app and the Client SDK run client side, your contract on the host chain, and CoFHE offchain. Hover any component or message in the [explorable version](/get-started/introduction/what-is-cofhe-explorable).
</Tip>
