---
title: How CoFHE Works, Explorable
mode: "wide"
...
<head>
  ...
  <title>How CoFHE Works Diagram</title>
  <script>
...
<body>
  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 880 600" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">How CoFHE Works</title>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="158" width="784" height="148" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="316" width="784" height="62" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="2" x="48" y="388" width="784" height="114" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 144.5 142 L 144.5 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 348.83333333333337 142 L 348.83333333333337 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 553.1666666666667 142 L 553.1666666666667 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 757.5 142 L 757.5 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="343.83333333333337" y="184" width="10" height="320" rx="3" class="c-mask"/>
        <rect x="343.83333333333337" y="184" width="10" height="320" rx="3" class="c-external" stroke-width="1"/>
        <rect x="752.5" y="215" width="10" height="257" rx="3" class="c-mask"/>
        <rect x="752.5" y="215" width="10" height="257" rx="3" class="c-cloud" stroke-width="1"/>
        <rect x="548.1666666666667" y="287" width="10" height="63" rx="3" class="c-mask"/>
        <rect x="548.1666666666667" y="287" width="10" height="63" rx="3" class="c-backend" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="a plaintext value" data-edge-key="0" data-edge-id="plain">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="plain" data-composition-points="144.5,178.0;348.83333333333337,178.0" d="M 144.5 178.0 L 348.83333333333337 178.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="196.4666666666667" y="158" width="100.4" height="16" rx="3" class="c-mask"/>
          <text x="246.66666666666669" y="168" class="t-backend" font-size="9" text-anchor="middle">a plaintext value</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="cofhe" data-edge-label="encrypted input + ZK proof" data-edge-key="1" data-edge-id="prove">
          <path data-composition-edge-from="sdk" data-composition-edge-to="cofhe" data-composition-edge-id="prove" data-composition-points="353.83333333333337,220.0;752.5,220.0" d="M 353.83333333333337 220.0 L 752.5 220.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="479.5666666666667" y="200" width="147.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="553.1666666666667" y="210" class="t-backend" font-size="9" text-anchor="middle">encrypted input + ZK proof</text>
        </g>
        </g>

        <g data-edge-from="cofhe" data-edge-to="sdk" data-edge-label="signed encrypted handle" data-edge-key="2" data-edge-id="handle">
          <path data-composition-edge-from="cofhe" data-composition-edge-to="sdk" data-composition-edge-id="handle" data-composition-points="752.5,258.0;353.83333333333337,258.0" d="M 752.5 258.0 L 353.83333333333337 258.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="487.36666666666673" y="238" width="131.60000000000002" height="16" rx="3" class="c-mask"/>
          <text x="553.1666666666667" y="248" class="t-muted" font-size="9" text-anchor="middle">signed encrypted handle</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="contract" data-edge-label="transaction carrying the handle" data-edge-key="3" data-edge-id="tx">
          <path data-composition-edge-from="sdk" data-composition-edge-to="contract" data-composition-edge-id="tx" data-composition-points="353.83333333333337,292.0;548.1666666666667,292.0" d="M 353.83333333333337 292.0 L 548.1666666666667 292.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="364.40000000000003" y="272" width="173.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="451.00000000000006" y="282" class="t-backend" font-size="9" text-anchor="middle">transaction carrying the handle</text>
        </g>
        </g>

        <g data-edge-from="contract" data-edge-to="cofhe" data-edge-label="the operation, emitted onchain" data-edge-key="4" data-edge-id="op">
          <path data-composition-edge-from="contract" data-composition-edge-to="cofhe" data-composition-edge-id="op" data-composition-points="558.1666666666667,344.0;752.5,344.0" d="M 558.1666666666667 344.0 L 752.5 344.0" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
        <g data-detail="context">
          <rect x="571.3333333333334" y="324" width="168" height="16" rx="3" class="c-mask"/>
          <text x="655.3333333333334" y="334" class="t-messagebus" font-size="9" text-anchor="middle">the operation, emitted onchain</text>
        </g>
        </g>

        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="read the result, with an ACP" data-edge-key="5" data-edge-id="read">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="read" data-composition-points="144.5,402.0;343.83333333333337,402.0" d="M 144.5 402.0 L 343.83333333333337 402.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="167.86666666666667" y="382" width="157.6" height="16" rx="3" class="c-mask"/>
          <text x="246.66666666666669" y="392" class="t-backend" font-size="9" text-anchor="middle">read the result, with an ACP</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="cofhe" data-edge-label="decrypt request" data-edge-key="6" data-edge-id="decrypt">
          <path data-composition-edge-from="sdk" data-composition-edge-to="cofhe" data-composition-edge-id="decrypt" data-composition-points="353.83333333333337,434.0;752.5,434.0" d="M 353.83333333333337 434.0 L 752.5 434.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="508.16666666666674" y="414" width="90" height="16" rx="3" class="c-mask"/>
          <text x="553.1666666666667" y="424" class="t-backend" font-size="9" text-anchor="middle">decrypt request</text>
        </g>
        </g>

        <g data-edge-from="cofhe" data-edge-to="sdk" data-edge-label="sealed result, or a signed plaintext" data-edge-key="7" data-edge-id="reveal">
          <path data-composition-edge-from="cofhe" data-composition-edge-to="sdk" data-composition-edge-id="reveal" data-composition-points="752.5,466.0;353.83333333333337,466.0" d="M 752.5 466.0 L 353.83333333333337 466.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="453.5666666666667" y="446" width="199.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="553.1666666666667" y="456" class="t-muted" font-size="9" text-anchor="middle">sealed result, or a signed plaintext</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="app" data-edge-label="the revealed value" data-edge-key="8" data-edge-id="value">
          <path data-composition-edge-from="sdk" data-composition-edge-to="app" data-composition-edge-id="value" data-composition-points="343.83333333333337,498.0;144.5,498.0" d="M 343.83333333333337 498.0 L 144.5 498.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="193.86666666666667" y="478" width="105.60000000000001" height="16" rx="3" class="c-mask"/>
          <text x="246.66666666666669" y="488" class="t-muted" font-size="9" text-anchor="middle">the revealed value</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="136" width="50.4" height="18" rx="3" class="c-mask"/>
          <text x="62" y="149" class="t-dim" font-size="9" font-weight="600">Encrypt</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="294" width="50.4" height="18" rx="3" class="c-mask"/>
          <text x="62" y="307" class="t-dim" font-size="9" font-weight="600">Compute</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="2">
          <rect x="56" y="366" width="50.4" height="18" rx="3" class="c-mask"/>
          <text x="62" y="379" class="t-dim" font-size="9" font-weight="600">Decrypt</text>
        </g>
        ...
        <g id="node-app" data-node-id="app" data-node-label="Your app" tabindex="0" role="button" aria-label="Focus Your app, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          ...
          <rect x="62" y="72" width="165" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="165" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          ...
          <text data-node-label="" x="144.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your app</text>
        </g>
        ...
        <g id="node-sdk" data-node-id="sdk" data-node-label="Client SDK" tabindex="0" role="button" aria-label="Focus Client SDK, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          ...
          <rect x="266.33333333333337" y="72" width="165" height="54" rx="6" class="c-mask"/>
          <rect x="266.33333333333337" y="72" width="165" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="external" class="semantic-sigil s-external" transform="translate(272.33333333333337 78) scale(0.6875)">
            <rect x="2.5" y="5" width="8.5" height="8" rx="1.5"/>
            <path d="M8 2.5h5.5V8M13.5 2.5 7.5 8.5"/>
          </g>
          <text data-node-label="" x="348.83333333333337" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Client SDK</text>
        </g>
        ...
        <g id="node-contract" data-node-id="contract" data-node-label="Your contract" tabindex="0" role="button" aria-label="Focus Your contract, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          ...
          <rect x="470.66666666666674" y="72" width="165" height="54" rx="6" class="c-mask"/>
          <rect x="470.66666666666674" y="72" width="165" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(476.66666666666674 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="553.1666666666667" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your contract</text>
        </g>
        ...
        <g id="node-cofhe" data-node-id="cofhe" data-node-label="CoFHE" tabindex="0" role="button" aria-label="Focus CoFHE, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          ...
          <rect x="675" y="72" width="165" height="54" rx="6" class="c-mask"/>
          <rect x="675" y="72" width="165" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(681 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="757.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">CoFHE</text>
        </g>
        ...
        <g data-legend="">
          ...
          <g data-legend-semantic-kind="dashed" data-legend-x="235" data-legend-baseline="546" data-legend-width="98">
            <path d="M 235 543 L 269 543" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
            <text x="278" y="546" class="t-muted" font-size="10" font-weight="500">async trace</text>
          </g>
          <g data-legend-semantic-kind="default" data-legend-x="355" data-legend-baseline="546" data-legend-width="118">
            <path d="M 355 543 L 389 543" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
            <text x="398" y="546" class="t-muted" font-size="10" font-weight="500">default message</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        <div class="card-header">
          ...
          <h3>Encrypted before it leaves</h3>
        </div>
        <ul>
          <li>&bull; The value is encrypted on the user&#39;s own machine</li>
          <li>&bull; A zero-knowledge proof shows the encryption is well formed</li>
          <li>&bull; The chain only ever sees a handle, never the value</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Your contract stays ordinary Solidity</h3>
        </div>
        <ul>
          <li>&bull; FHE.add, FHE.lt and FHE.select read like normal calls</li>
          <li>&bull; Each one derives a result handle deterministically, and returns straight away</li>
          <li>&bull; The operation is emitted onchain; nothing comes back to the contract</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Revealed only to whoever may see it</h3>
        </div>
        <ul>
          <li>&bull; CoFHE picks the operation up and computes the ciphertext for that handle</li>
          <li>&bull; Decryption is authorised against the onchain ACL first</li>
          <li>&bull; The result comes back sealed to an ACP, or signed for onchain publication</li>
        </ul>
      </div>
    </div>
...
<iframe
  ...
  title="How CoFHE Works, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "844 / 530", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
