...
<thead>
<tr>
<th style={{ whiteSpace: "nowrap" }}>Signer</th>
<th>Verifies</th>
</tr>
</thead>
<tbody>
<tr>
<td style={{ whiteSpace: "nowrap" }}><code>verifierSigner</code></td>
<td>Encrypted inputs: the ZK Verifier signs each input it verified, and <code>verifyInput</code> checks that signature before emitting <code>InputVerified(ctHash, commitment)</code>.</td>
</tr>
<tr>
<td style={{ whiteSpace: "nowrap" }}><code>decryptResultSigner</code></td>
<td>Decrypt results: <a href="/deep-dive/cofhe-components/teecryptor">Teecryptor</a> signs each plaintext it returns, and the publish path checks that signature before storing the result.</td>
</tr>
</tbody>
</table>
