  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 900 520" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        ...
        <!-- Messages -->
        <g data-edge-from="ceremony" data-edge-to="partners" data-edge-label="one encrypted share each, attested write" data-edge-key="0" data-edge-id="shares">
        ...
        <g data-detail="context">
          <rect x="141.66666666666669" y="158" width="220" height="16" rx="3" class="c-mask"/>
          <text x="251.66666666666669" y="168" class="t-security" font-size="9" text-anchor="middle">one encrypted share each, attested write</text>
        </g>
        </g>
        ...
        <g data-edge-from="enclave" data-edge-to="partners" data-edge-label="attestation of the running image" data-edge-key="2" data-edge-id="attest">
        ...
        <g data-detail="context">
          <rect x="476.46666666666675" y="280" width="178.4" height="16" rx="3" class="c-mask"/>
          <text x="565.6666666666667" y="290" class="t-security" font-size="9" text-anchor="middle">attestation of the running image</text>
        </g>
        </g>

        <g data-edge-from="partners" data-edge-to="enclave" data-edge-label="the share, only to the approved image" data-edge-key="3" data-edge-id="release">
        ...
        <g data-detail="context">
          <rect x="463.46666666666675" y="320" width="204.4" height="16" rx="3" class="c-mask"/>
          <text x="565.6666666666667" y="330" class="t-muted" font-size="9" text-anchor="middle">the share, only to the approved image</text>
        </g>
        </g>
        ...
        <g id="node-enclave" data-node-id="enclave" data-node-label="Component enclave" tabindex="0" role="button" aria-label="Focus Component enclave, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          <title>Component enclave · Sequence participant</title>
          ...
          <text data-node-label="" x="775" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Component enclave</text>
        </g>
    ...
    <div class="cards">
      ...
      <div class="card">
        ...
        <ul>
          ...
          <li>&bull; No partner can reconstruct anything alone, and nor can Fhenix</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Released only to reviewed code</h3>
        </div>
        <ul>
          <li>&bull; At boot the TEE hardware attests the exact image that is running</li>
          <li>&bull; Each partner verifies that attestation independently</li>
          <li>&bull; The enclave reconstructs the key in memory and zeroizes the transit material</li>
        </ul>
      </div>
    </div>
