---
title: Key Management, Explorable
mode: "wide"
...
<head>
  ...
  <title>Key Generation and Release Diagram</title>
  <script>
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="header-row"
        ...
        <h1>Key Generation and Release</h1>
      </div>
    </div>
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 900 520" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">Key Generation and Release</title>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="158" width="804" height="96" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="272" width="804" height="80" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 147 142 L 147 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 356.33333333333337 142 L 356.33333333333337 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 565.6666666666667 142 L 565.6666666666667 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 775 142 L 775 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="142" y="173" width="10" height="55" rx="3" class="c-mask"/>
        <rect x="142" y="173" width="10" height="55" rx="3" class="c-cloud" stroke-width="1"/>
        <rect x="351.33333333333337" y="295" width="10" height="51" rx="3" class="c-mask"/>
        <rect x="351.33333333333337" y="295" width="10" height="51" rx="3" class="c-external" stroke-width="1"/>
        <rect x="770" y="295" width="10" height="51" rx="3" class="c-mask"/>
        <rect x="770" y="295" width="10" height="51" rx="3" class="c-cloud" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="ceremony" data-edge-to="partners" data-edge-label="one share per partner, split per consumer" data-edge-key="0" data-edge-id="shares">
          <path data-composition-edge-from="ceremony" data-composition-edge-to="partners" data-composition-edge-id="shares" data-composition-points="152.0,178.0;356.33333333333337,178.0" d="M 152.0 178.0 L 356.33333333333337 178.0" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
          <rect x="139.06666666666666" y="158" width="225.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="251.66666666666669" y="168" class="t-security" font-size="9" text-anchor="middle">one share per partner, split per consumer</text>
        </g>
        </g>

        <g data-edge-from="ceremony" data-edge-to="public" data-edge-label="publish the public material" data-edge-key="1" data-edge-id="publish">
          <path data-composition-edge-from="ceremony" data-composition-edge-to="public" data-composition-edge-id="publish" data-composition-points="152.0,222.0;565.6666666666667,222.0" d="M 152.0 222.0 L 565.6666666666667 222.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="280.1333333333334" y="202" width="152.4" height="16" rx="3" class="c-mask"/>
          <text x="356.33333333333337" y="212" class="t-backend" font-size="9" text-anchor="middle">publish the public material</text>
        </g>
        </g>

        <g data-edge-from="enclave" data-edge-to="partners" data-edge-label="cofhe-keys asks, with the image attestation" data-edge-key="2" data-edge-id="attest">
          <path data-composition-edge-from="enclave" data-composition-edge-to="partners" data-composition-edge-id="attest" data-composition-points="770.0,300.0;361.33333333333337,300.0" d="M 770.0 300.0 L 361.33333333333337 300.0" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
          <rect x="447.86666666666673" y="280" width="235.6" height="16" rx="3" class="c-mask"/>
          <text x="565.6666666666667" y="290" class="t-security" font-size="9" text-anchor="middle">cofhe-keys asks, with the image attestation</text>
        </g>
        </g>

        <g data-edge-from="partners" data-edge-to="enclave" data-edge-label="its own share, only to the approved image" data-edge-key="3" data-edge-id="release">
          <path data-composition-edge-from="partners" data-composition-edge-to="enclave" data-composition-edge-id="release" data-composition-points="361.33333333333337,340.0;770.0,340.0" d="M 361.33333333333337 340.0 L 770.0 340.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="453.0666666666667" y="320" width="225.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="565.6666666666667" y="330" class="t-muted" font-size="9" text-anchor="middle">its own share, only to the approved image</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="136" width="123.2" height="18" rx="3" class="c-mask"/>
          <text x="62" y="149" class="t-dim" font-size="9" font-weight="600">Once, at the ceremony</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="250" width="164.8" height="18" rx="3" class="c-mask"/>
          <text x="62" y="263" class="t-dim" font-size="9" font-weight="600">Again at every component boot</text>
        </g>

        <!-- Participants -->
        <g id="node-ceremony" data-node-id="ceremony" data-node-label="Keygen ceremony" tabindex="0" role="button" aria-label="Focus Keygen ceremony, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          <title>Keygen ceremony · Sequence participant</title>
          <rect x="62" y="72" width="170" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="170" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(68 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="147" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Keygen ceremony</text>
        </g>

        <g id="node-partners" data-node-id="partners" data-node-label="Partners" tabindex="0" role="button" aria-label="Focus Partners, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          <title>Partners · Sequence participant</title>
          <rect x="271.33333333333337" y="72" width="170" height="54" rx="6" class="c-mask"/>
          <rect x="271.33333333333337" y="72" width="170" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="external" class="semantic-sigil s-external" transform="translate(277.33333333333337 78) scale(0.6875)">
            <rect x="2.5" y="5" width="8.5" height="8" rx="1.5"/>
            <path d="M8 2.5h5.5V8M13.5 2.5 7.5 8.5"/>
          </g>
          <text data-node-label="" x="356.33333333333337" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Partners</text>
        </g>

        <g id="node-public" data-node-id="public" data-node-label="Public material" tabindex="0" role="button" aria-label="Focus Public material, Sequence participant" aria-pressed="false" data-node-kind="database" data-node-context="Sequence participant">
          <title>Public material · Sequence participant</title>
          <rect x="480.66666666666674" y="72" width="170" height="54" rx="6" class="c-mask"/>
          <rect x="480.66666666666674" y="72" width="170" height="54" rx="6" class="c-database" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="database" class="semantic-sigil s-database" transform="translate(486.66666666666674 78) scale(0.6875)">
            <ellipse cx="8" cy="4" rx="5" ry="2"/>
            <path d="M3 4v8c0 1.1 2.2 2 5 2s5-.9 5-2V4M3 8c0 1.1 2.2 2 5 2s5-.9 5-2"/>
          </g>
          <text data-node-label="" x="565.6666666666667" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Public material</text>
        </g>

        <g id="node-enclave" data-node-id="enclave" data-node-label="Teecryptor or ZK Verifier" tabindex="0" role="button" aria-label="Focus Teecryptor or ZK Verifier, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          <title>Teecryptor or ZK Verifier · Sequence participant</title>
          <rect x="690" y="72" width="170" height="54" rx="6" class="c-mask"/>
          <rect x="690" y="72" width="170" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(696 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="775" y="94" class="t-primary" font-size="10.8" font-weight="600" text-anchor="middle">Teecryptor or ZK Verifier</text>
        </g>

        <!-- Legend -->
        <g data-legend="">
          <text x="40" y="446" class="t-primary" font-size="12" font-weight="650">Legend</text>
          <g data-legend-semantic-kind="return" data-legend-x="40" data-legend-baseline="466" data-legend-width="73">
            <path d="M 40 463 L 74 463" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
            <text x="83" y="466" class="t-muted" font-size="10" font-weight="500">return</text>
          </g>
          <g data-legend-semantic-kind="security" data-legend-x="135" data-legend-baseline="466" data-legend-width="83">
            <path d="M 135 463 L 169 463" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
            <text x="178" y="466" class="t-muted" font-size="10" font-weight="500">security</text>
          </g>
          <g data-legend-semantic-kind="default" data-legend-x="240" data-legend-baseline="466" data-legend-width="118">
            <path d="M 240 463 L 274 463" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
            <text x="283" y="466" class="t-muted" font-size="10" font-weight="500">default message</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        <div class="card-header">
          ...
          <h3>Born inside an enclave</h3>
        </div>
        <ul>
          <li>&bull; The keyset is generated in a hardware-attested enclave, never outside one</li>
          <li>&bull; Secrets are split with Shamir secret sharing, three of six</li>
          <li>&bull; The ceremony then terminates, and the whole key is never persisted anywhere</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Held by independent partners</h3>
        </div>
        <ul>
          <li>&bull; Each partner is an independent custodian with its own share store</li>
          <li>&bull; A store accepts writes only from the attested ceremony image</li>
          <li>&bull; Teecryptor and the ZK Verifier each read only the share they need, enforced by access control</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Read by the consumer itself</h3>
        </div>
        <ul>
          <li>&bull; cofhe-keys is compiled into the component, so the attestation covers the code that reconstructs</li>
          <li>&bull; It gathers what it can reach, discards any share failing its digest, and rebuilds from the threshold</li>
          <li>&bull; The result is checked against the published digest, then the transit material is zeroized</li>
        </ul>
      </div>
    </div>
...
<iframe
  ...
  title="Key Management, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "864 / 450", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
