...
<Frame>
<img src="/images/overview.svg" alt="CoFHE architecture: the Client SDK above your contracts on the host chain, the independent partners above CoFHE offchain with the ZK Verifier, Teecryptor, the ciphertext store and the compute pipeline, and the CommitmentRegistry on the registry chain to the right" />
</Frame>
