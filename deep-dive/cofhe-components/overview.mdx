...
<Frame>
<img src="/images/overview.svg" alt="CoFHE architecture: the Client SDK and your contract on the host chain, CoFHE offchain holding the partners, Teecryptor, the ZK Verifier, the ciphertext store and the compute pipeline, and the CommitmentRegistry on the registry chain" style={{ width: "100%" }} />
</Frame>
