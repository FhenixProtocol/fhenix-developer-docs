...
<Tip>
Your app and the Client SDK run client side, your contract and the TaskManager on the host chain, the ZK Verifier and compute pipeline offchain inside CoFHE, and the CommitmentRegistry on the registry chain. Hover any component or message in the [explorable version](/deep-dive/cofhe-components/zk-verifier-explorable).
</Tip>
