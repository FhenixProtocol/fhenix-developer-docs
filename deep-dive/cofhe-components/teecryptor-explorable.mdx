---
title: Teecryptor Pipeline, Explorable
mode: "wide"
...
<head>
  ...
  <title>Teecryptor Request Pipeline Diagram</title>
  <script>
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="header-row"
        ...
        <h1>Teecryptor Request Pipeline</h1>
      </div>
    </div>
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 860 520" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">Teecryptor Request Pipeline</title>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="158" width="764" height="114" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="282" width="764" height="94" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="2" x="48" y="386" width="764" height="40" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 142 142 L 142 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 341.33333333333337 142 L 341.33333333333337 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 540.6666666666667 142 L 540.6666666666667 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 740 142 L 740 455" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="535.6666666666667" y="173" width="10" height="245" rx="3" class="c-mask"/>
        <rect x="535.6666666666667" y="173" width="10" height="245" rx="3" class="c-cloud" stroke-width="1"/>
        <rect x="336.33333333333337" y="217" width="10" height="45" rx="3" class="c-mask"/>
        <rect x="336.33333333333337" y="217" width="10" height="45" rx="3" class="c-backend" stroke-width="1"/>
        <rect x="735" y="297" width="10" height="53" rx="3" class="c-mask"/>
        <rect x="735" y="297" width="10" height="53" rx="3" class="c-database" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="sdk" data-edge-to="teecryptor" data-edge-label="decrypt / sealoutput (handle, chain id, acp?)" data-edge-key="0" data-edge-id="request">
          <path data-composition-edge-from="sdk" data-composition-edge-to="teecryptor" data-composition-edge-id="request" data-composition-points="142.0,178.0;535.6666666666667,178.0" d="M 142.0 178.0 L 535.6666666666667 178.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="218.33333333333337" y="158" width="246" height="16" rx="3" class="c-mask"/>
          <text x="341.33333333333337" y="168" class="t-backend" font-size="9" text-anchor="middle">decrypt / sealoutput (handle, chain id, acp?)</text>
        </g>
        </g>

        <g data-edge-from="teecryptor" data-edge-to="taskmanager" data-edge-label="isAllowedWithPermission / isPubliclyAllowed" data-edge-key="1" data-edge-id="acl">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="taskmanager" data-composition-edge-id="acl" data-composition-points="535.6666666666667,222.0;346.33333333333337,222.0" d="M 535.6666666666667 222.0 L 346.33333333333337 222.0" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
          <rect x="323.20000000000005" y="202" width="235.6" height="16" rx="3" class="c-mask"/>
          <text x="441.00000000000006" y="212" class="t-security" font-size="9" text-anchor="middle">isAllowedWithPermission / isPubliclyAllowed</text>
        </g>
        </g>

        <g data-edge-from="taskmanager" data-edge-to="teecryptor" data-edge-label="allowed" data-edge-key="2" data-edge-id="allowed">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="teecryptor" data-composition-edge-id="allowed" data-composition-points="346.33333333333337,256.0;535.6666666666667,256.0" d="M 346.33333333333337 256.0 L 535.6666666666667 256.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="416.80000000000007" y="236" width="48.4" height="16" rx="3" class="c-mask"/>
          <text x="441.00000000000006" y="246" class="t-muted" font-size="9" text-anchor="middle">allowed</text>
        </g>
        </g>
        ...
        <g data-edge-from="teecryptor" data-edge-to="registry" data-edge-label="getCommitment(version, handle)" data-edge-key="3" data-edge-id="commit">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="registry" data-composition-edge-id="commit" data-composition-points="545.6666666666667,302.0;735.0,302.0" d="M 545.6666666666667 302.0 L 735.0 302.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="556.3333333333334" y="282" width="168" height="16" rx="3" class="c-mask"/>
          <text x="640.3333333333334" y="292" class="t-backend" font-size="9" text-anchor="middle">getCommitment(version, handle)</text>
        </g>
        </g>

        <g data-edge-from="registry" data-edge-to="teecryptor" data-edge-label="expected hash" data-edge-key="4" data-edge-id="hash">
          <path data-composition-edge-from="registry" data-composition-edge-to="teecryptor" data-composition-edge-id="hash" data-composition-points="735.0,344.0;545.6666666666667,344.0" d="M 735.0 344.0 L 545.6666666666667 344.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="600.5333333333334" y="324" width="79.60000000000001" height="16" rx="3" class="c-mask"/>
          <text x="640.3333333333334" y="334" class="t-muted" font-size="9" text-anchor="middle">expected hash</text>
        </g>
        </g>
        ...
        <g data-edge-from="teecryptor" data-edge-to="sdk" data-edge-label="plaintext + signature, or sealed output" data-edge-key="5" data-edge-id="result">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="sdk" data-composition-edge-id="result" data-composition-points="535.6666666666667,412.0;142.0,412.0" d="M 535.6666666666667 412.0 L 142.0 412.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="233.93333333333337" y="392" width="214.8" height="16" rx="3" class="c-mask"/>
          <text x="341.33333333333337" y="402" class="t-muted" font-size="9" text-anchor="middle">plaintext + signature, or sealed output</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="136" width="60.800000000000004" height="18" rx="3" class="c-mask"/>
          <text x="62" y="149" class="t-dim" font-size="9" font-weight="600">Authorize</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="260" width="123.2" height="18" rx="3" class="c-mask"/>
          <text x="62" y="273" class="t-dim" font-size="9" font-weight="600">Verify the ciphertext</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="2">
          <rect x="56" y="364" width="45.2" height="18" rx="3" class="c-mask"/>
          <text x="62" y="377" class="t-dim" font-size="9" font-weight="600">Return</text>
        </g>
        ...
        <g id="node-sdk" data-node-id="sdk" data-node-label="Client SDK" tabindex="0" role="button" aria-label="Focus Client SDK, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          ...
          <rect x="62" y="72" width="160" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="160" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          ...
          <text data-node-label="" x="142" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Client SDK</text>
        </g>
        ...
        <g id="node-taskmanager" data-node-id="taskmanager" data-node-label="TaskManager" tabindex="0" role="button" aria-label="Focus TaskManager, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          ...
          <rect x="261.33333333333337" y="72" width="160" height="54" rx="6" class="c-mask"/>
          <rect x="261.33333333333337" y="72" width="160" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(267.33333333333337 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="341.33333333333337" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">TaskManager</text>
        </g>
        ...
        <g id="node-teecryptor" data-node-id="teecryptor" data-node-label="Teecryptor" tabindex="0" role="button" aria-label="Focus Teecryptor, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          ...
          <rect x="460.66666666666674" y="72" width="160" height="54" rx="6" class="c-mask"/>
          <rect x="460.66666666666674" y="72" width="160" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(466.66666666666674 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="540.6666666666667" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Teecryptor</text>
        </g>
        ...
        <g id="node-registry" data-node-id="registry" data-node-label="CommitmentRegistry" tabindex="0" role="button" aria-label="Focus CommitmentRegistry, Sequence participant" aria-pressed="false" data-node-kind="database" data-node-context="Sequence participant">
          ...
          <rect x="660" y="72" width="160" height="54" rx="6" class="c-mask"/>
          <rect x="660" y="72" width="160" height="54" rx="6" class="c-database" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="database" class="semantic-sigil s-database" transform="translate(666 78) scale(0.6875)">
            <ellipse cx="8" cy="4" rx="5" ry="2"/>
            <path d="M3 4v8c0 1.1 2.2 2 5 2s5-.9 5-2V4M3 8c0 1.1 2.2 2 5 2s5-.9 5-2"/>
          </g>
          <text data-node-label="" x="740" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">CommitmentRegistry</text>
        </g>

        <!-- Legend -->
        <g data-legend="">
          <text x="40" y="446" class="t-primary" font-size="12" font-weight="650">Legend</text>
          <g data-legend-semantic-kind="emphasis" data-legend-x="40" data-legend-baseline="466" data-legend-width="78">
            <path d="M 40 463 L 74 463" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
            <text x="83" y="466" class="t-muted" font-size="10" font-weight="500">request</text>
          </g>
          <g data-legend-semantic-kind="return" data-legend-x="140" data-legend-baseline="466" data-legend-width="73">
            <path d="M 140 463 L 174 463" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
            <text x="183" y="466" class="t-muted" font-size="10" font-weight="500">return</text>
          </g>
          <g data-legend-semantic-kind="security" data-legend-x="235" data-legend-baseline="466" data-legend-width="83">
            <path d="M 235 463 L 269 463" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
            <text x="278" y="466" class="t-muted" font-size="10" font-weight="500">security</text>
          </g>
          <g data-legend-semantic-kind="default" data-legend-x="340" data-legend-baseline="466" data-legend-width="118">
            <path d="M 340 463 L 374 463" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
            <text x="383" y="466" class="t-muted" font-size="10" font-weight="500">default message</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        <div class="card-header">
          ...
          <h3>Fails closed, twice</h3>
        </div>
        <ul>
          <li>&bull; No onchain ACL allowance, no decryption</li>
          <li>&bull; No commitment for the handle, no decryption</li>
          <li>&bull; Both checks run concurrently, on two different chains</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>The bytes must match</h3>
        </div>
        <ul>
          <li>&bull; The ciphertext is fetched from the CT Server exactly as the FHE Engine stored it</li>
          <li>&bull; Its bytes must hash to the commitment anchored onchain</li>
          <li>&bull; The bytes that were hashed are the bytes that get decrypted</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Signed or sealed</h3>
        </div>
        <ul>
          <li>&bull; decrypt signs the plaintext with a key that never leaves the enclave</li>
          <li>&bull; sealoutput encrypts it to the ACP&#39;s sealing key instead</li>
          <li>&bull; Only the ACP holder can read a sealed result</li>
        </ul>
      </div>
    </div>
...
<iframe
  ...
  title="Teecryptor Pipeline, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "824 / 450", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
