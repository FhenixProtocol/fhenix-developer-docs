  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 860 520" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        ...
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="2" x="48" y="386" width="764" height="56" rx="10" class="c-lane" stroke-width="1"/>
        ...
        <g data-edge-from="sdk" data-edge-to="teecryptor" data-edge-label="decrypt / sealoutput (handle, chain id, acp?)" data-edge-key="0" data-edge-id="request">
          <path data-composition-edge-from="sdk" data-composition-edge-to="teecryptor" data-composition-edge-id="request" data-composition-points="149,178;533.6666666666667,178" d="M 149 178 L 533.6666666666667 178" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        ...
        <g data-edge-from="teecryptor" data-edge-to="taskmanager" data-edge-label="isAllowedWithPermission / isPubliclyAllowed" data-edge-key="1" data-edge-id="acl">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="taskmanager" data-composition-edge-id="acl" data-composition-points="533.6666666666667,222;348.33333333333337,222" d="M 533.6666666666667 222 L 348.33333333333337 222" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="taskmanager" data-edge-to="teecryptor" data-edge-label="allowed" data-edge-key="2" data-edge-id="allowed">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="teecryptor" data-composition-edge-id="allowed" data-composition-points="348.33333333333337,256;533.6666666666667,256" d="M 348.33333333333337 256 L 533.6666666666667 256" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="teecryptor" data-edge-to="registry" data-edge-label="getCommitment(version, handle)" data-edge-key="3" data-edge-id="commit">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="registry" data-composition-edge-id="commit" data-composition-points="547.6666666666667,302;733,302" d="M 547.6666666666667 302 L 733 302" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="registry" data-edge-to="teecryptor" data-edge-label="expected hash" data-edge-key="4" data-edge-id="hash">
          <path data-composition-edge-from="registry" data-composition-edge-to="teecryptor" data-composition-edge-id="hash" data-composition-points="733,344;547.6666666666667,344" d="M 733 344 L 547.6666666666667 344" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="teecryptor" data-edge-to="sdk" data-edge-label="plaintext + signature, or sealed output" data-edge-key="5" data-edge-id="result">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="sdk" data-composition-edge-id="result" data-composition-points="533.6666666666667,412;149,412" d="M 533.6666666666667 412 L 149 412" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
