    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 760 480" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        ...
        <g data-edge-from="pipeline" data-edge-to="registry" data-edge-label="postCommitments (batched)" data-edge-key="0" data-edge-id="post">
          <path data-composition-edge-from="pipeline" data-composition-edge-to="registry" data-composition-edge-id="post" data-composition-points="163,184;619,184" d="M 163 184 L 619 184" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        ...
        <g data-edge-from="teecryptor" data-edge-to="registry" data-edge-label="getCommitment(version, handle)" data-edge-key="1" data-edge-id="lookup">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="registry" data-composition-edge-id="lookup" data-composition-points="398,286;619,286" d="M 398 286 L 619 286" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="registry" data-edge-to="teecryptor" data-edge-label="expected hash" data-edge-key="2" data-edge-id="hash">
          <path data-composition-edge-from="registry" data-composition-edge-to="teecryptor" data-composition-edge-id="hash" data-composition-points="619,336;398,336" d="M 619 336 L 398 336" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
