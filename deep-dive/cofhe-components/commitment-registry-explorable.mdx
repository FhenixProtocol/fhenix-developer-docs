---
title: Commitment Write and Read, Explorable
mode: "wide"
...
<head>
  ...
  <title>Who Writes and Who Reads Diagram</title>
  <script>
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="header-row"
        ...
        <h1>Who Writes and Who Reads</h1>
      </div>
    </div>
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 760 480" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">Who Writes and Who Reads</title>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="158" width="664" height="86" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="254" width="664" height="130" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 156 142 L 156 415" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 391 142 L 391 415" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 626 142 L 626 415" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="151" y="179" width="10" height="43" rx="3" class="c-mask"/>
        <rect x="151" y="179" width="10" height="43" rx="3" class="c-cloud" stroke-width="1"/>
        <rect x="386" y="281" width="10" height="61" rx="3" class="c-mask"/>
        <rect x="386" y="281" width="10" height="61" rx="3" class="c-cloud" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="pipeline" data-edge-to="registry" data-edge-label="postCommitments (batched)" data-edge-key="0" data-edge-id="post">
          <path data-composition-edge-from="pipeline" data-composition-edge-to="registry" data-composition-edge-id="post" data-composition-points="161.0,184.0;626.0,184.0" d="M 161.0 184.0 L 626.0 184.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="320" y="164" width="142" height="16" rx="3" class="c-mask"/>
          <text x="391" y="174" class="t-backend" font-size="9" text-anchor="middle">postCommitments (batched)</text>
        </g>
        </g>

        <g data-edge-from="teecryptor" data-edge-to="registry" data-edge-label="getCommitment(version, handle)" data-edge-key="1" data-edge-id="lookup">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="registry" data-composition-edge-id="lookup" data-composition-points="396.0,286.0;626.0,286.0" d="M 396.0 286.0 L 626.0 286.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="424.5" y="266" width="168" height="16" rx="3" class="c-mask"/>
          <text x="508.5" y="276" class="t-backend" font-size="9" text-anchor="middle">getCommitment(version, handle)</text>
        </g>
        </g>

        <g data-edge-from="registry" data-edge-to="teecryptor" data-edge-label="expected hash" data-edge-key="2" data-edge-id="hash">
          <path data-composition-edge-from="registry" data-composition-edge-to="teecryptor" data-composition-edge-id="hash" data-composition-points="626.0,336.0;396.0,336.0" d="M 626.0 336.0 L 396.0 336.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="468.7" y="316" width="79.60000000000001" height="16" rx="3" class="c-mask"/>
          <text x="508.5" y="326" class="t-muted" font-size="9" text-anchor="middle">expected hash</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="136" width="211.6" height="18" rx="3" class="c-mask"/>
          <text x="62" y="149" class="t-dim" font-size="9" font-weight="600">Write, when the ciphertext is produced</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="232" width="190.8" height="18" rx="3" class="c-mask"/>
          <text x="62" y="245" class="t-dim" font-size="9" font-weight="600">Read, whenever someone decrypts it</text>
        </g>
        ...
        <g id="node-pipeline" data-node-id="pipeline" data-node-label="Compute pipeline" tabindex="0" role="button" aria-label="Focus Compute pipeline, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          ...
          <rect x="62" y="72" width="188" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="188" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          ...
          <text data-node-label="" x="156" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Compute pipeline</text>
        </g>
        ...
        <g id="node-teecryptor" data-node-id="teecryptor" data-node-label="Teecryptor" tabindex="0" role="button" aria-label="Focus Teecryptor, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          ...
          <rect x="297" y="72" width="188" height="54" rx="6" class="c-mask"/>
          <rect x="297" y="72" width="188" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(303 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="391" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Teecryptor</text>
        </g>
        ...
        <g id="node-registry" data-node-id="registry" data-node-label="CommitmentRegistry" tabindex="0" role="button" aria-label="Focus CommitmentRegistry, Sequence participant" aria-pressed="false" data-node-kind="database" data-node-context="Sequence participant">
          ...
          <rect x="532" y="72" width="188" height="54" rx="6" class="c-mask"/>
          <rect x="532" y="72" width="188" height="54" rx="6" class="c-database" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="database" class="semantic-sigil s-database" transform="translate(538 78) scale(0.6875)">
            <ellipse cx="8" cy="4" rx="5" ry="2"/>
            <path d="M3 4v8c0 1.1 2.2 2 5 2s5-.9 5-2V4M3 8c0 1.1 2.2 2 5 2s5-.9 5-2"/>
          </g>
          <text data-node-label="" x="626" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">CommitmentRegistry</text>
        </g>

        <!-- Legend -->
        <g data-legend="">
          <text x="40" y="406" class="t-primary" font-size="12" font-weight="650">Legend</text>
          <g data-legend-semantic-kind="emphasis" data-legend-x="40" data-legend-baseline="426" data-legend-width="78">
            <path d="M 40 423 L 74 423" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
            <text x="83" y="426" class="t-muted" font-size="10" font-weight="500">request</text>
          </g>
          <g data-legend-semantic-kind="return" data-legend-x="140" data-legend-baseline="426" data-legend-width="73">
            <path d="M 140 423 L 174 423" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
            <text x="183" y="426" class="t-muted" font-size="10" font-weight="500">return</text>
          </g>
          <g data-legend-semantic-kind="default" data-legend-x="235" data-legend-baseline="426" data-legend-width="118">
            <path d="M 235 423 L 269 423" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
            <text x="278" y="426" class="t-muted" font-size="10" font-weight="500">default message</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        ...
        <ul>
          <li>&bull; The compute pipeline posts a commitment for every ciphertext it produces</li>
          <li>&bull; It anchors one for every encrypted input the ZK Verifier approves</li>
          <li>&bull; Only accounts holding the poster role can write</li>
        </ul>
      </div>
      ...
      <div class="card">
        ...
        <ul>
          <li>&bull; Teecryptor looks up the commitment before it decrypts anything</li>
          <li>&bull; It refuses bytes that do not hash to the registered value</li>
          <li>&bull; A posted commitment is immutable, so a positive answer can be cached</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Write once, per version</h3>
        </div>
        <ul>
          <li>&bull; A commitment can never be overwritten, only superseded under a new version</li>
          <li>&bull; The version tag groups commitments so FHE parameters can change</li>
          <li>&bull; Commitments for every host chain land on one registry chain</li>
        </ul>
      </div>
    </div>
...
<iframe
  ...
  title="Commitment Write and Read, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "724 / 410", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
