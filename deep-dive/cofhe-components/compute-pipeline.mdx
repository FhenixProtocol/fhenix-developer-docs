...
<Frame>
<img src="/images/compute-pipeline.svg" alt="The compute pipeline: TaskManager feeds the slim listener, FheOS, the FHE Engine and the blockchain poster, which posts commitments to the registry chain" style={{ width: "100%" }} />
</Frame>
