...
<Tip>
Colour marks the zone. The four pipeline components run offchain inside CoFHE; the TaskManager is on the host chain and the CommitmentRegistry on the registry chain.
</Tip>
