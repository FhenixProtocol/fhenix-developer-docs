...
- **`decryptForView`**: returns the plaintext sealed to your [permit](/client-sdk/guides/acps) (an ACP, Access Control Permission, onchain), for UI display and offchain reads. Guide: [Decrypt to View](/client-sdk/guides/decrypt-to-view).
