...
{/* Diagram source: decryption-request-flow.mmd, beside this page. Edit it first, then re-run the archify build. */}
<Frame>
<img src="/images/decryption-request-flow.svg" alt="Sequence diagram of the decryption flow" style={{ width: "100%" }} />
</Frame>

<Tip>
Your app and the Client SDK run client side, your contract and the TaskManager on the host chain, Teecryptor offchain inside CoFHE, and the CommitmentRegistry on the registry chain. Hover any component or message in the [explorable version](/deep-dive/data-flows/decryption-request-flow-explorable).
</Tip>
