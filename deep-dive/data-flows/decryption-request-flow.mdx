...
- **`decryptForView`**: returns the plaintext sealed to your [permit](/client-sdk/guides/permits), for UI display and offchain reads. Guide: [Decrypt to View](/client-sdk/guides/decrypt-to-view).
