...
<Frame>
<img src="/images/fhe-operation-request-flow.svg" alt="Sequence diagram of the fhe operation flow" style={{ width: "100%" }} />
</Frame>

<Tip>
Each color is one zone from the table above. Hover any component or message in the [explorable version](/deep-dive/data-flows/fhe-operation-request-flow-explorable).
</Tip>
