---
title: Decryption Flow, Explorable
mode: "wide"
...
<head>
  ...
  <title>Decryption Flow Diagram</title>
  <script>
...
<body>
  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 1080 600" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">Decryption Flow</title>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="158" width="984" height="142" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="310" width="984" height="94" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="2" x="48" y="414" width="984" height="92" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 129.5 142 L 129.5 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 298.1 142 L 298.1 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 466.7 142 L 466.7 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 635.3 142 L 635.3 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 803.9 142 L 803.9 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 972.5 142 L 972.5 535" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="293.1" y="182" width="10" height="290" rx="3" class="c-mask"/>
        <rect x="293.1" y="182" width="10" height="290" rx="3" class="c-external" stroke-width="1"/>
        <rect x="798.9" y="217" width="10" height="217" rx="3" class="c-mask"/>
        <rect x="798.9" y="217" width="10" height="217" rx="3" class="c-cloud" stroke-width="1"/>
        <rect x="630.3" y="263" width="10" height="243" rx="3" class="c-mask"/>
        <rect x="630.3" y="263" width="10" height="243" rx="3" class="c-backend" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="decryptForTx / decryptForView (ctHash)" data-edge-key="0" data-edge-id="ask">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="ask" data-composition-points="129.5,176.0;298.1,176.0" d="M 129.5 176.0 L 298.1 176.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="109.00000000000001" y="156" width="209.6" height="16" rx="3" class="c-mask"/>
          <text x="213.8" y="166" class="t-backend" font-size="9" text-anchor="middle">decryptForTx / decryptForView (ctHash)</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="teecryptor" data-edge-label="decrypt / sealoutput (handle, chain id, acp?)" data-edge-key="1" data-edge-id="request">
          <path data-composition-edge-from="sdk" data-composition-edge-to="teecryptor" data-composition-edge-id="request" data-composition-points="303.1,222.0;798.9,222.0" d="M 303.1 222.0 L 798.9 222.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="428" y="202" width="246" height="16" rx="3" class="c-mask"/>
          <text x="551" y="212" class="t-backend" font-size="9" text-anchor="middle">decrypt / sealoutput (handle, chain id, acp?)</text>
        </g>
        </g>

        <g data-edge-from="teecryptor" data-edge-to="taskmanager" data-edge-label="isAllowedWithPermission / isPubliclyAllowed" data-edge-key="2" data-edge-id="acl">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="taskmanager" data-composition-edge-id="acl" data-composition-points="798.9,268.0;640.3,268.0" d="M 798.9 268.0 L 640.3 268.0" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
          <rect x="601.8" y="248" width="235.6" height="16" rx="3" class="c-mask"/>
          <text x="719.5999999999999" y="258" class="t-security" font-size="9" text-anchor="middle">isAllowedWithPermission / isPubliclyAllowed</text>
        </g>
        </g>

        <g data-edge-from="teecryptor" data-edge-to="registry" data-edge-label="getCommitment(version, handle)" data-edge-key="3" data-edge-id="commit">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="registry" data-composition-edge-id="commit" data-composition-points="808.9,320.0;972.5,320.0" d="M 808.9 320.0 L 972.5 320.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="804.2" y="300" width="168" height="16" rx="3" class="c-mask"/>
          <text x="888.2" y="310" class="t-backend" font-size="9" text-anchor="middle">getCommitment(version, handle)</text>
        </g>
        </g>

        <g data-edge-from="registry" data-edge-to="teecryptor" data-edge-label="expected hash" data-edge-key="4" data-edge-id="hash">
          <path data-composition-edge-from="registry" data-composition-edge-to="teecryptor" data-composition-edge-id="hash" data-composition-points="972.5,364.0;808.9,364.0" d="M 972.5 364.0 L 808.9 364.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="848.4000000000001" y="344" width="79.60000000000001" height="16" rx="3" class="c-mask"/>
          <text x="888.2" y="354" class="t-muted" font-size="9" text-anchor="middle">expected hash</text>
        </g>
        </g>

        <g data-edge-from="teecryptor" data-edge-to="sdk" data-edge-label="plaintext + signature, or sealed output" data-edge-key="5" data-edge-id="result">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="sdk" data-composition-edge-id="result" data-composition-points="798.9,428.0;303.1,428.0" d="M 798.9 428.0 L 303.1 428.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="443.6" y="408" width="214.8" height="16" rx="3" class="c-mask"/>
          <text x="551" y="418" class="t-muted" font-size="9" text-anchor="middle">plaintext + signature, or sealed output</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="app" data-edge-label="the decrypted value" data-edge-key="6" data-edge-id="value">
          <path data-composition-edge-from="sdk" data-composition-edge-to="app" data-composition-edge-id="value" data-composition-points="293.1,466.0;129.5,466.0" d="M 293.1 466.0 L 129.5 466.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="158.4" y="446" width="110.8" height="16" rx="3" class="c-mask"/>
          <text x="213.8" y="456" class="t-muted" font-size="9" text-anchor="middle">the decrypted value</text>
        </g>
        </g>

        <g data-edge-from="contract" data-edge-to="taskmanager" data-edge-label="FHE.publishDecryptResult, for the tx path" data-edge-key="7" data-edge-id="publish">
          <path data-composition-edge-from="contract" data-composition-edge-to="taskmanager" data-composition-edge-id="publish" data-composition-points="466.7,500.0;630.3,500.0" d="M 466.7 500.0 L 630.3 500.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="438.4" y="480" width="225.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="551" y="490" class="t-backend" font-size="9" text-anchor="middle">FHE.publishDecryptResult, for the tx path</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="136" width="42" height="18" rx="3" class="c-mask"/>
          <text x="62" y="149" class="t-dim" font-size="9" font-weight="600">Ask</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="288" width="222" height="18" rx="3" class="c-mask"/>
          <text x="62" y="301" class="t-dim" font-size="9" font-weight="600">Authorize and verify, two chains at once</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="2">
          <rect x="56" y="392" width="50.4" height="18" rx="3" class="c-mask"/>
          <text x="62" y="405" class="t-dim" font-size="9" font-weight="600">Deliver</text>
        </g>
        ...
        <g id="node-app" data-node-id="app" data-node-label="Your app" tabindex="0" role="button" aria-label="Focus Your app, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          ...
          <rect x="62" y="72" width="135" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="135" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          ...
          <text data-node-label="" x="129.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your app</text>
        </g>
        ...
        <g id="node-sdk" data-node-id="sdk" data-node-label="Client SDK" tabindex="0" role="button" aria-label="Focus Client SDK, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          ...
          <rect x="230.60000000000002" y="72" width="135" height="54" rx="6" class="c-mask"/>
          <rect x="230.60000000000002" y="72" width="135" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="external" class="semantic-sigil s-external" transform="translate(236.60000000000002 78) scale(0.6875)">
            <rect x="2.5" y="5" width="8.5" height="8" rx="1.5"/>
            <path d="M8 2.5h5.5V8M13.5 2.5 7.5 8.5"/>
          </g>
          <text data-node-label="" x="298.1" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Client SDK</text>
        </g>
        ...
        <g id="node-contract" data-node-id="contract" data-node-label="Your contract" tabindex="0" role="button" aria-label="Focus Your contract, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          ...
          <rect x="399.2" y="72" width="135" height="54" rx="6" class="c-mask"/>
          <rect x="399.2" y="72" width="135" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(405.2 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="466.7" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your contract</text>
        </g>
        ...
        <g id="node-taskmanager" data-node-id="taskmanager" data-node-label="TaskManager" tabindex="0" role="button" aria-label="Focus TaskManager, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          ...
          <rect x="567.8" y="72" width="135" height="54" rx="6" class="c-mask"/>
          <rect x="567.8" y="72" width="135" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(573.8 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="635.3" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">TaskManager</text>
        </g>

        <g id="node-teecryptor" data-node-id="teecryptor" data-node-label="Teecryptor" tabindex="0" role="button" aria-label="Focus Teecryptor, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          <title>Teecryptor · Sequence participant</title>
          <rect x="736.4" y="72" width="135" height="54" rx="6" class="c-mask"/>
          <rect x="736.4" y="72" width="135" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(742.4 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="803.9" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Teecryptor</text>
        </g>
        ...
        <g id="node-registry" data-node-id="registry" data-node-label="CommitmentRegistry" tabindex="0" role="button" aria-label="Focus CommitmentRegistry, Sequence participant" aria-pressed="false" data-node-kind="database" data-node-context="Sequence participant">
          ...
          <rect x="905" y="72" width="135" height="54" rx="6" class="c-mask"/>
          <rect x="905" y="72" width="135" height="54" rx="6" class="c-database" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="database" class="semantic-sigil s-database" transform="translate(911 78) scale(0.6875)">
            <ellipse cx="8" cy="4" rx="5" ry="2"/>
            <path d="M3 4v8c0 1.1 2.2 2 5 2s5-.9 5-2V4M3 8c0 1.1 2.2 2 5 2s5-.9 5-2"/>
          </g>
          <text data-node-label="" x="972.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">CommitmentRegistry</text>
        </g>

        <!-- Legend -->
        <g data-legend="">
          <text x="40" y="526" class="t-primary" font-size="12" font-weight="650">Legend</text>
          <g data-legend-semantic-kind="emphasis" data-legend-x="40" data-legend-baseline="546" data-legend-width="78">
            <path d="M 40 543 L 74 543" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
            <text x="83" y="546" class="t-muted" font-size="10" font-weight="500">request</text>
          </g>
          <g data-legend-semantic-kind="return" data-legend-x="140" data-legend-baseline="546" data-legend-width="73">
            <path d="M 140 543 L 174 543" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
            <text x="183" y="546" class="t-muted" font-size="10" font-weight="500">return</text>
          </g>
          <g data-legend-semantic-kind="security" data-legend-x="235" data-legend-baseline="546" data-legend-width="83">
            <path d="M 235 543 L 269 543" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
            <text x="278" y="546" class="t-muted" font-size="10" font-weight="500">security</text>
          </g>
          <g data-legend-semantic-kind="default" data-legend-x="340" data-legend-baseline="546" data-legend-width="118">
            <path d="M 340 543 L 374 543" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
            <text x="383" y="546" class="t-muted" font-size="10" font-weight="500">default message</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        <div class="card-header">
          ...
          <h3>Two checks, on two chains</h3>
        </div>
        <ul>
          <li>&bull; The ACL grant is read on the host chain, the commitment on the registry chain</li>
          <li>&bull; They run at the same time, because neither depends on the other</li>
          <li>&bull; A terminal ACL rejection wins over a still-pending commitment</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Only committed bytes are decrypted</h3>
        </div>
        <ul>
          <li>&bull; Teecryptor fetches the ciphertext from the CT Server exactly as stored</li>
          <li>&bull; The bytes must hash to the commitment, or the request is refused</li>
          <li>&bull; Decryption happens inside the attested enclave, never outside it</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Two destinations</h3>
        </div>
        <ul>
          <li>&bull; decryptForTx returns a signed plaintext anyone can publish onchain</li>
          <li>&bull; decryptForView returns a result sealed to the ACP, unsealed by the SDK</li>
          <li>&bull; A handle whose ciphertext has not landed yet is retryable, not an error</li>
        </ul>
      </div>
    </div>
...
<iframe
  ...
  title="Decryption Flow, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "1044 / 530", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
