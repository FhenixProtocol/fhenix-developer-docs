    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 1080 600" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        ...
        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="decryptForTx / decryptForView (ctHash)" data-edge-key="0" data-edge-id="ask">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="ask" data-composition-points="136.5,176;291.1,176" d="M 136.5 176 L 291.1 176" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        ...
        <g data-edge-from="sdk" data-edge-to="teecryptor" data-edge-label="decrypt / sealoutput (handle, chain id, acp?)" data-edge-key="1" data-edge-id="request">
          <path data-composition-edge-from="sdk" data-composition-edge-to="teecryptor" data-composition-edge-id="request" data-composition-points="305.1,222;796.9,222" d="M 305.1 222 L 796.9 222" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="teecryptor" data-edge-to="taskmanager" data-edge-label="isAllowedWithPermission / isPubliclyAllowed" data-edge-key="2" data-edge-id="acl">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="taskmanager" data-composition-edge-id="acl" data-composition-points="796.9,268;642.3,268" d="M 796.9 268 L 642.3 268" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="teecryptor" data-edge-to="registry" data-edge-label="getCommitment(version, handle)" data-edge-key="3" data-edge-id="commit">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="registry" data-composition-edge-id="commit" data-composition-points="810.9,320;965.5,320" d="M 810.9 320 L 965.5 320" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="registry" data-edge-to="teecryptor" data-edge-label="expected hash" data-edge-key="4" data-edge-id="hash">
          <path data-composition-edge-from="registry" data-composition-edge-to="teecryptor" data-composition-edge-id="hash" data-composition-points="965.5,364;810.9,364" d="M 965.5 364 L 810.9 364" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="teecryptor" data-edge-to="sdk" data-edge-label="plaintext + signature, or sealed output" data-edge-key="5" data-edge-id="result">
          <path data-composition-edge-from="teecryptor" data-composition-edge-to="sdk" data-composition-edge-id="result" data-composition-points="796.9,428;305.1,428" d="M 796.9 428 L 305.1 428" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="sdk" data-edge-to="app" data-edge-label="the decrypted value" data-edge-key="6" data-edge-id="value">
          <path data-composition-edge-from="sdk" data-composition-edge-to="app" data-composition-edge-id="value" data-composition-points="291.1,466;136.5,466" d="M 291.1 466 L 136.5 466" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="contract" data-edge-to="taskmanager" data-edge-label="FHE.publishDecryptResult, for the tx path" data-edge-key="7" data-edge-id="publish">
          <path data-composition-edge-from="contract" data-composition-edge-to="taskmanager" data-composition-edge-id="publish" data-composition-points="473.7,500;628.3,500" d="M 473.7 500 L 628.3 500" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
