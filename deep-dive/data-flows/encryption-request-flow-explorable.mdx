...
<body>
  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 1180 620" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
...
<iframe
  ...
  allowFullScreen
  loading="lazy"
  style={{ width: "100%", aspectRatio: "1180 / 712", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#020617" }}
/>
