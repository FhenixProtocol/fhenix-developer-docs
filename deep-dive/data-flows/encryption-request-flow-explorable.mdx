...
mode: "wide"
description: "The encryption request flow as an explorable diagram: hover any component or message to highlight it"
---
...
html,body{margin:0!important;padding:0!important;background:var(--bg)!important;overflow:hidden!important}
...
/* the corner brackets are a container decoration a standalone SVG cannot carry;
   drop them so the two renderings are the same picture */
  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 1180 588" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        ...
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="2" x="48" y="460" width="1084" height="66" rx="10" class="c-lane" stroke-width="1"/>
        ...
        <rect x="279" y="192" width="10" height="144" rx="3" class="c-external" stroke-width="1"/>
        <rect x="754.5" y="231" width="10" height="61" rx="3" class="c-mask"/>
        <rect x="754.5" y="231" width="10" height="61" rx="3" class="c-cloud" stroke-width="1"/>
        ...
        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="encryptInputs([...]).setConsumingContract(addr)" data-edge-key="0" data-edge-id="encrypt-call">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="encrypt-call" data-composition-points="125.5,186.0;284.0,186.0" d="M 125.5 186.0 L 284.0 186.0" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        ...
        <g data-edge-from="sdk" data-edge-to="zkverifier" data-edge-label="ciphertext batch + proofs" data-edge-key="1" data-edge-id="submit-batch">
          <path data-composition-edge-from="sdk" data-composition-edge-to="zkverifier" data-composition-edge-id="submit-batch" data-composition-points="289.0,236.0;754.5,236.0" d="M 289.0 236.0 L 754.5 236.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="zkverifier" data-edge-to="sdk" data-edge-label="handles + one batch signature" data-edge-key="2" data-edge-id="batch-signature">
          <path data-composition-edge-from="zkverifier" data-composition-edge-to="sdk" data-composition-edge-id="batch-signature" data-composition-points="754.5,286.0;289.0,286.0" d="M 754.5 286.0 L 289.0 286.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="sdk" data-edge-to="app" data-edge-label="[handles..., proof]" data-edge-key="3" data-edge-id="handles-to-app">
          <path data-composition-edge-from="sdk" data-composition-edge-to="app" data-composition-edge-id="handles-to-app" data-composition-points="279.0,330.0;125.5,330.0" d="M 279.0 330.0 L 125.5 330.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="app" data-edge-to="contract" data-edge-label="contract call with handles + proof" data-edge-key="4" data-edge-id="contract-call">
          <path data-composition-edge-from="app" data-composition-edge-to="contract" data-composition-edge-id="contract-call" data-composition-points="125.5,382.0;437.5,382.0" d="M 125.5 382.0 L 437.5 382.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="contract" data-edge-to="taskmanager" data-edge-label="batchVerifyInputs" data-edge-key="5" data-edge-id="batch-verify">
          <path data-composition-edge-from="contract" data-composition-edge-to="taskmanager" data-composition-edge-id="batch-verify" data-composition-points="447.5,428.0;596.0,428.0" d="M 447.5 428.0 L 596.0 428.0" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="taskmanager" data-edge-to="pipeline" data-edge-label="InputVerified per input" data-edge-key="6" data-edge-id="input-verified">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="pipeline" data-composition-edge-id="input-verified" data-composition-points="606.0,478.0;913.0,478.0" d="M 606.0 478.0 L 913.0 478.0" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="pipeline" data-edge-to="registry" data-edge-label="postCommitments (batched)" data-edge-key="7" data-edge-id="post-commitments">
          <path data-composition-edge-from="pipeline" data-composition-edge-to="registry" data-composition-edge-id="post-commitments" data-composition-points="923.0,522.0;1076.5,522.0" d="M 923.0 522.0 L 1076.5 522.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
        ...
        <g id="node-sdk" data-node-id="sdk" data-node-label="Client SDK" tabindex="0" role="button" aria-label="Focus Client SDK, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          <title>Client SDK · Sequence participant</title>
          <rect x="220.5" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="220.5" y="72" width="127" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="external" class="semantic-sigil s-external" transform="translate(226.5 78) scale(0.6875)">
            <rect x="2.5" y="5" width="8.5" height="8" rx="1.5"/>
            <path d="M8 2.5h5.5V8M13.5 2.5 7.5 8.5"/>
          </g>
        ...
        <g id="node-zkverifier" data-node-id="zkverifier" data-node-label="ZK Verifier" tabindex="0" role="button" aria-label="Focus ZK Verifier, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          <title>ZK Verifier · Sequence participant</title>
          <rect x="696" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="696" y="72" width="127" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(702 78) scale(0.6875)">
...
<iframe
  ...
  loading="lazy"
  style={{ width: "100%", aspectRatio: "1180 / 600", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
