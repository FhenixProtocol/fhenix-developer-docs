...
mode: "wide"
description: "The same flow as an explorable diagram: hover any component or message to highlight it"
---
...
/* the house palette; the preset defines these at [data-preset][data-theme],
   so the override needs at least that specificity */
html[data-preset][data-theme]{
  --bg:#122531; --panel:rgba(18,37,49,0.92); --grid:#1e3d52;
  --external-stroke:#0466A2; --external-fill:rgba(4,102,162,0.18);
  --backend-stroke:#F37A49;  --backend-fill:rgba(243,122,73,0.15);
  --cloud-stroke:#0AD9DC;    --cloud-fill:rgba(10,217,220,0.13);
  --database-stroke:#BF90F8; --database-fill:rgba(191,144,248,0.15);
}
...
<iframe
  ...
  title="Encryption Flow, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "1144 / 550", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
