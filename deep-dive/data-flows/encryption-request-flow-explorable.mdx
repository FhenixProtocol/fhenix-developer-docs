---
title: Encryption Flow, Explorable
description: "The encryption request flow as an explorable diagram: hover a component to highlight it, click the background to enlarge"
---

export const diagram = `<!DOCTYPE html>
<html lang="en" data-theme="dark" data-preset="blueprint">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="generator" content="archify 2.17.0-dev.1">
  <title>Encryption Request Flow Diagram</title>
  <script>
...
<style id="embed-chrome-off">
/* Embedded view: the diagram and nothing else. */
.toolbar,.header,.guided-views,.cards,.diagram-nav{display:none!important}
html,body{margin:0!important;padding:0!important;background:#020617!important;overflow:hidden!important}
.container{max-width:none!important;width:100%!important;padding:0!important;margin:0!important}
/* the bottom reserve existed for the dock we just removed */
.diagram-container{--archify-nav-reserve:0px!important;margin:0!important;border:none!important;
  border-radius:0!important;box-shadow:none!important;padding:6px!important;overflow:hidden!important}
/* fit the column instead of rendering at natural width */
.diagram-container>svg{width:100%!important;height:auto!important;max-width:100%!important}
/* the type sigils in each participant tile add nothing here */
.semantic-sigil{display:none!important}
/* no focus ring on the frame itself; keyboard focus on components still shows */
html:focus,body:focus,.container:focus,.diagram-container:focus,
.diagram-container:focus-visible,svg:focus,svg:focus-visible{outline:none!important;box-shadow:none!important}
html{cursor:zoom-in}
/* enlarged: a floating card on a dimmed ground, not an edge-to-edge fullscreen */
html:fullscreen{cursor:zoom-out;background:rgba(2,6,23,.97)!important}
html:fullscreen body,html:fullscreen .container{height:100vh!important;display:flex!important;
  align-items:center!important;justify-content:center!important}
html:fullscreen .diagram-container{width:min(92vw,1560px)!important;max-height:88vh!important;
  padding:22px!important;background:#0b1424!important;border:1px solid #24405f!important;
  border-radius:16px!important;box-shadow:0 40px 120px rgba(0,0,0,.7)!important}
html:fullscreen .diagram-container>svg{width:100%!important;height:auto!important;max-height:84vh!important}
</style>
</head>
<body>
  ...
  <div class="container">
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 1180 588" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">Encryption Request Flow</title>
        <desc id="archify-diagram-description">A sequence diagram generated by Archify.</desc>
        <!-- Definitions -->
        <defs>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="166" width="1084" height="186" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="364" width="1084" height="84" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="2" x="48" y="460" width="1084" height="86" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 125.5 142 L 125.5 555" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 284 142 L 284 555" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 442.5 142 L 442.5 555" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 601 142 L 601 555" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 759.5 142 L 759.5 555" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 918 142 L 918 555" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 1076.5 142 L 1076.5 555" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="279" y="192" width="10" height="144" rx="3" class="c-mask"/>
        <rect x="279" y="192" width="10" height="144" rx="3" class="c-frontend" stroke-width="1"/>
        <rect x="754.5" y="231" width="10" height="61" rx="3" class="c-mask"/>
        <rect x="754.5" y="231" width="10" height="61" rx="3" class="c-security" stroke-width="1"/>
        <rect x="437.5" y="377" width="10" height="57" rx="3" class="c-mask"/>
        <rect x="437.5" y="377" width="10" height="57" rx="3" class="c-backend" stroke-width="1"/>
        <rect x="596" y="423" width="10" height="61" rx="3" class="c-mask"/>
        <rect x="596" y="423" width="10" height="61" rx="3" class="c-backend" stroke-width="1"/>
        <rect x="913" y="473" width="10" height="55" rx="3" class="c-mask"/>
        <rect x="913" y="473" width="10" height="55" rx="3" class="c-cloud" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="app" data-edge-to="sdk" data-edge-label="encryptInputs([...]).setConsumingContract(addr)" data-edge-key="0" data-edge-id="encrypt-call">
          <path data-composition-edge-from="app" data-composition-edge-to="sdk" data-composition-edge-id="encrypt-call" data-composition-points="132.5,186;277,186" d="M 132.5 186 L 277 186" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="76.55000000000001" y="166" width="256.4" height="16" rx="3" class="c-mask"/>
          <text x="204.75" y="176" class="t-backend" font-size="9" text-anchor="middle">encryptInputs([...]).setConsumingContract(addr)</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="zkverifier" data-edge-label="ciphertext batch + proofs" data-edge-key="1" data-edge-id="submit-batch">
          <path data-composition-edge-from="sdk" data-composition-edge-to="zkverifier" data-composition-edge-id="submit-batch" data-composition-points="291,236;752.5,236" d="M 291 236 L 752.5 236" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="450.75" y="216" width="142" height="16" rx="3" class="c-mask"/>
          <text x="521.75" y="226" class="t-backend" font-size="9" text-anchor="middle">ciphertext batch + proofs</text>
        </g>
        </g>

        <g data-edge-from="zkverifier" data-edge-to="sdk" data-edge-label="handles + one batch signature" data-edge-key="2" data-edge-id="batch-signature">
          <path data-composition-edge-from="zkverifier" data-composition-edge-to="sdk" data-composition-edge-id="batch-signature" data-composition-points="752.5,286;291,286" d="M 752.5 286 L 291 286" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="440.35" y="266" width="162.8" height="16" rx="3" class="c-mask"/>
          <text x="521.75" y="276" class="t-muted" font-size="9" text-anchor="middle">handles + one batch signature</text>
        </g>
        </g>

        <g data-edge-from="sdk" data-edge-to="app" data-edge-label="[handles..., proof]" data-edge-key="3" data-edge-id="handles-to-app">
          <path data-composition-edge-from="sdk" data-composition-edge-to="app" data-composition-edge-id="handles-to-app" data-composition-points="277,330;132.5,330" d="M 277 330 L 132.5 330" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="149.35" y="310" width="110.8" height="16" rx="3" class="c-mask"/>
          <text x="204.75" y="320" class="t-muted" font-size="9" text-anchor="middle">[handles..., proof]</text>
        </g>
        </g>

        <g data-edge-from="app" data-edge-to="contract" data-edge-label="contract call with handles + proof" data-edge-key="4" data-edge-id="contract-call">
          <path data-composition-edge-from="app" data-composition-edge-to="contract" data-composition-edge-id="contract-call" data-composition-points="132.5,382;435.5,382" d="M 132.5 382 L 435.5 382" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="189.6" y="362" width="188.8" height="16" rx="3" class="c-mask"/>
          <text x="284" y="372" class="t-backend" font-size="9" text-anchor="middle">contract call with handles + proof</text>
        </g>
        </g>

        <g data-edge-from="contract" data-edge-to="taskmanager" data-edge-label="batchVerifyInputs" data-edge-key="5" data-edge-id="batch-verify">
          <path data-composition-edge-from="contract" data-composition-edge-to="taskmanager" data-composition-edge-id="batch-verify" data-composition-points="449.5,428;594,428" d="M 449.5 428 L 594 428" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
        <g data-detail="context">
          <rect x="471.55" y="408" width="100.4" height="16" rx="3" class="c-mask"/>
          <text x="521.75" y="418" class="t-security" font-size="9" text-anchor="middle">batchVerifyInputs</text>
        </g>
        </g>

        <g data-edge-from="taskmanager" data-edge-to="pipeline" data-edge-label="InputVerified per input" data-edge-key="6" data-edge-id="input-verified">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="pipeline" data-composition-edge-id="input-verified" data-composition-points="608,478;911,478" d="M 608 478 L 911 478" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
        <g data-detail="context">
          <rect x="693.7" y="458" width="131.60000000000002" height="16" rx="3" class="c-mask"/>
          <text x="759.5" y="468" class="t-messagebus" font-size="9" text-anchor="middle">InputVerified per input</text>
        </g>
        </g>

        <g data-edge-from="pipeline" data-edge-to="registry" data-edge-label="postCommitments (batched)" data-edge-key="7" data-edge-id="post-commitments">
          <path data-composition-edge-from="pipeline" data-composition-edge-to="registry" data-composition-edge-id="post-commitments" data-composition-points="925,522;1069.5,522" d="M 925 522 L 1069.5 522" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="926.25" y="502" width="142" height="16" rx="3" class="c-mask"/>
          <text x="997.25" y="512" class="t-backend" font-size="9" text-anchor="middle">postCommitments (batched)</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="144" width="170" height="18" rx="3" class="c-mask"/>
          <text x="62" y="157" class="t-dim" font-size="9" font-weight="600">Encrypt and prove, client side</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="342" width="92" height="18" rx="3" class="c-mask"/>
          <text x="62" y="355" class="t-dim" font-size="9" font-weight="600">Consume onchain</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="2">
          <rect x="56" y="438" width="107.60000000000001" height="18" rx="3" class="c-mask"/>
          <text x="62" y="451" class="t-dim" font-size="9" font-weight="600">Anchor every input</text>
        </g>

        <!-- Participants -->
        <g id="node-app" data-node-id="app" data-node-label="Your app" tabindex="0" role="button" aria-label="Focus Your app, Sequence participant" aria-pressed="false" data-node-kind="external" data-node-context="Sequence participant">
          <title>Your app · Sequence participant</title>
          <rect x="62" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="127" height="54" rx="6" class="c-external" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="external" class="semantic-sigil s-external" transform="translate(68 78) scale(0.6875)">
            <rect x="2.5" y="5" width="8.5" height="8" rx="1.5"/>
            <path d="M8 2.5h5.5V8M13.5 2.5 7.5 8.5"/>
          </g>
          <text data-node-label="" x="125.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your app</text>
        </g>

        <g id="node-sdk" data-node-id="sdk" data-node-label="Client SDK" tabindex="0" role="button" aria-label="Focus Client SDK, Sequence participant" aria-pressed="false" data-node-kind="frontend" data-node-context="Sequence participant">
          <title>Client SDK · Sequence participant</title>
          <rect x="220.5" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="220.5" y="72" width="127" height="54" rx="6" class="c-frontend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="frontend" class="semantic-sigil s-frontend" transform="translate(226.5 78) scale(0.6875)">
            <rect x="2" y="3" width="12" height="10" rx="2"/>
            <path d="M2 6.5h12"/>
            <circle cx="4.1" cy="4.8" r=".7" class="sigil-fill"/>
            <circle cx="6.3" cy="4.8" r=".7" class="sigil-fill"/>
          </g>
          <text data-node-label="" x="284" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Client SDK</text>
        </g>

        <g id="node-contract" data-node-id="contract" data-node-label="Your contract" tabindex="0" role="button" aria-label="Focus Your contract, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          <title>Your contract · Sequence participant</title>
          <rect x="379" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="379" y="72" width="127" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(385 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="442.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your contract</text>
        </g>

        <g id="node-taskmanager" data-node-id="taskmanager" data-node-label="TaskManager" tabindex="0" role="button" aria-label="Focus TaskManager, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          <title>TaskManager · Sequence participant</title>
          <rect x="537.5" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="537.5" y="72" width="127" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(543.5 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="601" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">TaskManager</text>
        </g>

        <g id="node-zkverifier" data-node-id="zkverifier" data-node-label="ZK Verifier" tabindex="0" role="button" aria-label="Focus ZK Verifier, Sequence participant" aria-pressed="false" data-node-kind="security" data-node-context="Sequence participant">
          <title>ZK Verifier · Sequence participant</title>
          <rect x="696" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="696" y="72" width="127" height="54" rx="6" class="c-security" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="security" class="semantic-sigil s-security" transform="translate(702 78) scale(0.6875)">
            <path d="M8 2.2 13 4v3.5c0 3.1-1.8 5.4-5 6.5-3.2-1.1-5-3.4-5-6.5V4Z"/>
            <path d="m5.8 8 1.5 1.5 3-3"/>
          </g>
          <text data-node-label="" x="759.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">ZK Verifier</text>
        </g>

        <g id="node-pipeline" data-node-id="pipeline" data-node-label="Compute pipeline" tabindex="0" role="button" aria-label="Focus Compute pipeline, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          <title>Compute pipeline · Sequence participant</title>
          <rect x="854.5" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="854.5" y="72" width="127" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(860.5 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="918" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Compute pipeline</text>
        </g>

        <g id="node-registry" data-node-id="registry" data-node-label="CommitmentRegistry" tabindex="0" role="button" aria-label="Focus CommitmentRegistry, Sequence participant" aria-pressed="false" data-node-kind="database" data-node-context="Sequence participant">
          <title>CommitmentRegistry · Sequence participant</title>
          <rect x="1013" y="72" width="127" height="54" rx="6" class="c-mask"/>
          <rect x="1013" y="72" width="127" height="54" rx="6" class="c-database" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="database" class="semantic-sigil s-database" transform="translate(1019 78) scale(0.6875)">
            <ellipse cx="8" cy="4" rx="5" ry="2"/>
            <path d="M3 4v8c0 1.1 2.2 2 5 2s5-.9 5-2V4M3 8c0 1.1 2.2 2 5 2s5-.9 5-2"/>
          </g>
          <text data-node-label="" x="1076.5" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">CommitmentRegistry</text>
        </g>

        <!-- Legend -->
        <g data-legend="">
          <text x="40" y="546" class="t-primary" font-size="12" font-weight="650">Legend</text>
          <g data-legend-semantic-kind="emphasis" data-legend-x="40" data-legend-baseline="566" data-legend-width="78">
            <path d="M 40 563 L 74 563" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
            <text x="83" y="566" class="t-muted" font-size="10" font-weight="500">request</text>
          </g>
          <g data-legend-semantic-kind="return" data-legend-x="140" data-legend-baseline="566" data-legend-width="73">
            <path d="M 140 563 L 174 563" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
            <text x="183" y="566" class="t-muted" font-size="10" font-weight="500">return</text>
          </g>
          <g data-legend-semantic-kind="security" data-legend-x="235" data-legend-baseline="566" data-legend-width="83">
            <path d="M 235 563 L 269 563" class="a-security" stroke-width="1.4" marker-end="url(#arrowhead-security)"/>
            <text x="278" y="566" class="t-muted" font-size="10" font-weight="500">security</text>
          </g>
          <g data-legend-semantic-kind="dashed" data-legend-x="340" data-legend-baseline="566" data-legend-width="98">
            <path d="M 340 563 L 374 563" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
            <text x="383" y="566" class="t-muted" font-size="10" font-weight="500">async trace</text>
          </g>
          <g data-legend-semantic-kind="default" data-legend-x="460" data-legend-baseline="566" data-legend-width="118">
            <path d="M 460 563 L 494 563" class="a-default" stroke-width="1.4" marker-end="url(#arrowhead)"/>
            <text x="503" y="566" class="t-muted" font-size="10" font-weight="500">default message</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        <div class="card-header">
          ...
          <h3>Everything sensitive stays local</h3>
        </div>
        <ul>
          <li>&bull; Your app and the Client SDK run on the client, and values are encrypted and proven there</li>
          <li>&bull; Only ciphertexts and their proofs ever leave the machine</li>
          <li>&bull; The batch signature binds to the consuming contract, so it cannot be replayed into a different one</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>One signature covers the batch</h3>
        </div>
        <ul>
          <li>&bull; The ZK Verifier checks every proof inside a hardware-attested TEE</li>
          <li>&bull; It signs one digest over the whole batch, never one signature per input</li>
          <li>&bull; TaskManager runs on the host chain and recovers that signature against verifierSigner</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Inputs are anchored like results</h3>
        </div>
        <ul>
          <li>&bull; The compute pipeline runs offchain and picks up each InputVerified event</li>
          <li>&bull; It posts a commitment per input to the CommitmentRegistry, on its own registry chain</li>
          <li>&bull; Teecryptor later refuses to decrypt bytes that do not hash to a registered commitment</li>
        </ul>
      </div>
    </div>
...
(function () {
  document.addEventListener('click', function (e) {
    // let the diagram keep its own click behaviour on nodes and messages
    if (e.target.closest && e.target.closest('[data-node-id],[data-edge-id],button,a')) return;
...
<style>{`.archify-style-probe{outline:3px solid #ff00ff}`}</style>
...
<iframe
  ...
  allowFullScreen
  loading="lazy"
  style={{ width: "100%", aspectRatio: "1180 / 600", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#020617" }}
/>
