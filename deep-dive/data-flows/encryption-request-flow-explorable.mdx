...
description: "The encryption request flow as an explorable diagram: pan, zoom, focus a component, and trace one message end to end"
---

Drag to pan, scroll to zoom, and click a component to focus everything it touches.
The same flow is explained step by step on the
[Encryption Request Flow](/deep-dive/data-flows/encryption-request-flow) page.
...
/* Embedded view: the diagram, a zoom control, nothing else. */
.toolbar,.header,.guided-views,.cards{display:none!important}
...
/* the 4.25rem bottom reserve existed for the full dock we just removed */
.diagram-container{--archify-nav-reserve:0px!important;margin:0!important;border:none!important;
  border-radius:0!important;box-shadow:none!important;padding:8px!important;overflow:hidden!important}
/* fit to the column instead of rendering at natural width */
.diagram-container>svg{width:100%!important;height:auto!important;max-width:100%!important}
/* keep only zoom out / reset / zoom in */
#btn-route-probe,#btn-overview-map,#btn-semantic-lens,#btn-node-finder,#btn-diagram-guide{display:none!important}
.diagram-nav{right:8px!important;bottom:8px!important;opacity:.85}
.diagram-nav:hover{opacity:1}
</style>
</head>
<body>
...
<iframe
  ...
  loading="lazy"
  style={{ width: "100%", height: "470px", border: "1px solid #1e293b", borderRadius: "10px", background: "#020617" }}
/>
