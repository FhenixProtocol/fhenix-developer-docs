...
{/* Diagram source: encryption-request-flow.mmd, next to this page. Update it first, then re-export the SVG. */}

**Option A, click to enlarge, no hover.** This is what you just saw.
...
**Option B, hover highlight, no zoom.** Point at a component box or a message line.

<object data="/images/encryption-request-flow.svg" type="image/svg+xml" style={{ width: "100%" }} />
