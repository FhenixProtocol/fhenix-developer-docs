...
<iframe
  src="/diagrams/encryption-request-flow.html"
  title="Encryption request flow, interactive diagram"
  style={{ width: "100%", height: "760px", border: "1px solid #1e293b", borderRadius: "8px" }}
/>
