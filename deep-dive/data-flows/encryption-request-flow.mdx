...
<Tip>
Colour marks where each component runs: client side, host chain, CoFHE offchain, and registry chain. Hover any component or message in the [explorable version](/deep-dive/data-flows/encryption-request-flow-explorable).
</Tip>
