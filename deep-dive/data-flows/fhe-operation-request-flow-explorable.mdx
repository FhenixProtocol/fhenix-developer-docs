    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 820 500" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        ...
        <g data-edge-from="contract" data-edge-to="taskmanager" data-edge-label="FHE.add(lhs, rhs) calls createTask" data-edge-key="0" data-edge-id="create">
          <path data-composition-edge-from="contract" data-composition-edge-to="taskmanager" data-composition-edge-id="create" data-composition-points="144,178;319.33333333333337,178" d="M 144 178 L 319.33333333333337 178" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        ...
        <g data-edge-from="taskmanager" data-edge-to="contract" data-edge-label="result handle, immediately" data-edge-key="1" data-edge-id="handle">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="contract" data-composition-edge-id="handle" data-composition-points="319.33333333333337,228;144,228" d="M 319.33333333333337 228 L 144 228" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="taskmanager" data-edge-to="pipeline" data-edge-label="TaskCreated event" data-edge-key="2" data-edge-id="event">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="pipeline" data-composition-edge-id="event" data-composition-points="333.33333333333337,278;508.66666666666674,278" d="M 333.33333333333337 278 L 508.66666666666674 278" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
        <g data-detail="context">
        ...
        <g data-edge-from="pipeline" data-edge-to="registry" data-edge-label="postCommitments (batched)" data-edge-key="3" data-edge-id="commit">
          <path data-composition-edge-from="pipeline" data-composition-edge-to="registry" data-composition-edge-id="commit" data-composition-points="522.6666666666667,384;698,384" d="M 522.6666666666667 384 L 698 384" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
