---
title: FHE Operation Flow, Explorable
mode: "wide"
...
<head>
  ...
  <title>FHE Operation Request Flow Diagram</title>
  <script>
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="header-row"
        ...
        <h1>FHE Operation Request Flow</h1>
      </div>
    </div>
    ...
    <div class="diagram-container" data-detail-level="read"
      ...
      <svg viewBox="0 0 820 500" role="img" lang="en" aria-labelledby="archify-diagram-title archify-diagram-description" data-preset="blueprint" data-quality-profile="showcase">
        <title id="archify-diagram-title">FHE Operation Request Flow</title>
        ...
        <!-- Time Segments -->
        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="0" x="48" y="158" width="724" height="132" rx="10" class="c-lane" stroke-width="1"/>

        <rect data-graph-role="structural-frame" data-composition-frame-kind="segment" data-composition-frame-id="1" x="48" y="300" width="724" height="106" rx="10" class="c-lane" stroke-width="1"/>

        <!-- Lifelines -->
        <path d="M 137 142 L 137 435" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 326.33333333333337 142 L 326.33333333333337 435" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 515.6666666666667 142 L 515.6666666666667 435" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>
        <path d="M 705 142 L 705 435" class="a-default" stroke-width="0.8" stroke-dasharray="3,7"/>

        <!-- Activations -->
        <rect x="321.33333333333337" y="173" width="10" height="117" rx="3" class="c-mask"/>
        <rect x="321.33333333333337" y="173" width="10" height="117" rx="3" class="c-backend" stroke-width="1"/>
        <rect x="510.66666666666674" y="273" width="10" height="117" rx="3" class="c-mask"/>
        <rect x="510.66666666666674" y="273" width="10" height="117" rx="3" class="c-cloud" stroke-width="1"/>

        <!-- Messages -->
        <g data-edge-from="contract" data-edge-to="taskmanager" data-edge-label="FHE.add(lhs, rhs) calls createTask" data-edge-key="0" data-edge-id="create">
          <path data-composition-edge-from="contract" data-composition-edge-to="taskmanager" data-composition-edge-id="create" data-composition-points="137.0,178.0;321.33333333333337,178.0" d="M 137.0 178.0 L 321.33333333333337 178.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="137.26666666666668" y="158" width="188.8" height="16" rx="3" class="c-mask"/>
          <text x="231.66666666666669" y="168" class="t-backend" font-size="9" text-anchor="middle">FHE.add(lhs, rhs) calls createTask</text>
        </g>
        </g>

        <g data-edge-from="taskmanager" data-edge-to="contract" data-edge-label="result handle, immediately" data-edge-key="1" data-edge-id="handle">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="contract" data-composition-edge-id="handle" data-composition-points="321.33333333333337,228.0;137.0,228.0" d="M 321.33333333333337 228.0 L 137.0 228.0" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
        <g data-detail="context">
          <rect x="158.06666666666666" y="208" width="147.20000000000002" height="16" rx="3" class="c-mask"/>
          <text x="231.66666666666669" y="218" class="t-muted" font-size="9" text-anchor="middle">result handle, immediately</text>
        </g>
        </g>

        <g data-edge-from="taskmanager" data-edge-to="pipeline" data-edge-label="TaskCreated event" data-edge-key="2" data-edge-id="event">
          <path data-composition-edge-from="taskmanager" data-composition-edge-to="pipeline" data-composition-edge-id="event" data-composition-points="331.33333333333337,278.0;510.66666666666674,278.0" d="M 331.33333333333337 278.0 L 510.66666666666674 278.0" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
        <g data-detail="context">
          <rect x="370.80000000000007" y="258" width="100.4" height="16" rx="3" class="c-mask"/>
          <text x="421.00000000000006" y="268" class="t-messagebus" font-size="9" text-anchor="middle">TaskCreated event</text>
        </g>
        </g>

        <g data-edge-from="pipeline" data-edge-to="registry" data-edge-label="postCommitments (batched)" data-edge-key="3" data-edge-id="commit">
          <path data-composition-edge-from="pipeline" data-composition-edge-to="registry" data-composition-edge-id="commit" data-composition-points="520.6666666666667,384.0;705.0,384.0" d="M 520.6666666666667 384.0 L 705.0 384.0" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
        <g data-detail="context">
          <rect x="539.3333333333334" y="364" width="142" height="16" rx="3" class="c-mask"/>
          <text x="610.3333333333334" y="374" class="t-backend" font-size="9" text-anchor="middle">postCommitments (batched)</text>
        </g>
        </g>

        <!-- Segment Labels -->
        <g data-graph-role="segment-label" data-segment-id="0">
          <rect x="56" y="136" width="118" height="18" rx="3" class="c-mask"/>
          <text x="62" y="149" class="t-dim" font-size="9" font-weight="600">Request, synchronous</text>
        </g>
        <g data-graph-role="segment-label" data-segment-id="1">
          <rect x="56" y="278" width="149.20000000000002" height="18" rx="3" class="c-mask"/>
          <text x="62" y="291" class="t-dim" font-size="9" font-weight="600">Compute, in the background</text>
        </g>
        ...
        <g id="node-contract" data-node-id="contract" data-node-label="Your contract" tabindex="0" role="button" aria-label="Focus Your contract, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          ...
          <rect x="62" y="72" width="150" height="54" rx="6" class="c-mask"/>
          <rect x="62" y="72" width="150" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(68 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="137" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Your contract</text>
        </g>
        ...
        <g id="node-taskmanager" data-node-id="taskmanager" data-node-label="TaskManager" tabindex="0" role="button" aria-label="Focus TaskManager, Sequence participant" aria-pressed="false" data-node-kind="backend" data-node-context="Sequence participant">
          ...
          <rect x="251.33333333333337" y="72" width="150" height="54" rx="6" class="c-mask"/>
          <rect x="251.33333333333337" y="72" width="150" height="54" rx="6" class="c-backend" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="backend" class="semantic-sigil s-backend" transform="translate(257.33333333333337 78) scale(0.6875)">
            <path d="M6 3 3 8l3 5M10 3l3 5-3 5"/>
          </g>
          <text data-node-label="" x="326.33333333333337" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">TaskManager</text>
        </g>
        ...
        <g id="node-pipeline" data-node-id="pipeline" data-node-label="Compute pipeline" tabindex="0" role="button" aria-label="Focus Compute pipeline, Sequence participant" aria-pressed="false" data-node-kind="cloud" data-node-context="Sequence participant">
          ...
          <rect x="440.66666666666674" y="72" width="150" height="54" rx="6" class="c-mask"/>
          <rect x="440.66666666666674" y="72" width="150" height="54" rx="6" class="c-cloud" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="cloud" class="semantic-sigil s-cloud" transform="translate(446.66666666666674 78) scale(0.6875)">
            <path d="M4.3 12.5h7.3a2.4 2.4 0 0 0 .2-4.8 4 4 0 0 0-7.5-1.3A3.1 3.1 0 0 0 4.3 12.5Z"/>
          </g>
          <text data-node-label="" x="515.6666666666667" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">Compute pipeline</text>
        </g>
        ...
        <g id="node-registry" data-node-id="registry" data-node-label="CommitmentRegistry" tabindex="0" role="button" aria-label="Focus CommitmentRegistry, Sequence participant" aria-pressed="false" data-node-kind="database" data-node-context="Sequence participant">
          ...
          <rect x="630" y="72" width="150" height="54" rx="6" class="c-mask"/>
          <rect x="630" y="72" width="150" height="54" rx="6" class="c-database" stroke-width="1.5"/>
          <g aria-hidden="true" data-semantic-sigil="database" class="semantic-sigil s-database" transform="translate(636 78) scale(0.6875)">
            <ellipse cx="8" cy="4" rx="5" ry="2"/>
            <path d="M3 4v8c0 1.1 2.2 2 5 2s5-.9 5-2V4M3 8c0 1.1 2.2 2 5 2s5-.9 5-2"/>
          </g>
          <text data-node-label="" x="705" y="94" class="t-primary" font-size="11" font-weight="600" text-anchor="middle">CommitmentRegistry</text>
        </g>

        <!-- Legend -->
        <g data-legend="">
          <text x="40" y="426" class="t-primary" font-size="12" font-weight="650">Legend</text>
          <g data-legend-semantic-kind="emphasis" data-legend-x="40" data-legend-baseline="446" data-legend-width="78">
            <path d="M 40 443 L 74 443" class="a-emphasis" stroke-width="1.8" marker-end="url(#arrowhead-emphasis)"/>
            <text x="83" y="446" class="t-muted" font-size="10" font-weight="500">request</text>
          </g>
          <g data-legend-semantic-kind="return" data-legend-x="140" data-legend-baseline="446" data-legend-width="73">
            <path d="M 140 443 L 174 443" class="a-default" stroke-width="1.4" stroke-dasharray="3,5" marker-end="url(#arrowhead)"/>
            <text x="183" y="446" class="t-muted" font-size="10" font-weight="500">return</text>
          </g>
          <g data-legend-semantic-kind="dashed" data-legend-x="235" data-legend-baseline="446" data-legend-width="98">
            <path d="M 235 443 L 269 443" class="a-dashed" stroke-width="1.4" marker-end="url(#arrowhead-dashed)"/>
            <text x="278" y="446" class="t-muted" font-size="10" font-weight="500">async trace</text>
          </g>
        </g>
      </svg>
    ...
    <div class="cards">
      <div class="card">
        <div class="card-header">
          ...
          <h3>The contract never waits</h3>
        </div>
        <ul>
          <li>&bull; TaskManager validates the request and checks the ACL for every input</li>
          <li>&bull; It returns a handle for the result straight away, so operations chain</li>
          <li>&bull; Nothing is computed yet; the handle is a promise, not a value</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>The pipeline picks it up</h3>
        </div>
        <ul>
          <li>&bull; It subscribes to TaskManager events on every host chain</li>
          <li>&bull; It validates and orders the task, deferring any whose inputs are not ready</li>
          <li>&bull; The FHE Engine computes, then stores the ciphertext under the handle</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Every result is anchored</h3>
        </div>
        <ul>
          <li>&bull; The commitment is the hash of the stored ciphertext bytes</li>
          <li>&bull; Commitments go up in batches, not one per result</li>
          <li>&bull; Teecryptor will only decrypt bytes that hash to a registered commitment</li>
        </ul>
      </div>
    </div>
...
<iframe
  ...
  title="FHE Operation Flow, Explorable"
  loading="lazy"
  style={{ width: "100%", aspectRatio: "784 / 430", display: "block", border: "1px solid #1e293b", borderRadius: "10px", background: "#06131f" }}
/>
