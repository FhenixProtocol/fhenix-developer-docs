...
| --- | --- | --- | --- |
| Teecryptor | Decryption is served by a single TEE service operated by Fhenix | Replace with the Threshold Network (below) | Planned |
| Teecryptor | Trust in the TEE hardware vendor and its attestation chain | Threshold decryption removes the hardware trust anchor | Planned |
